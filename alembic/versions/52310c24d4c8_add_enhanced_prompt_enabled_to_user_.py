...
def upgrade() -> None:
    # This revision was generated with a duplicate copy of the initial schema.
    # The schema is already created by dd8212a8f22a; keep this revision in the
    # chain for existing databases without attempting to recreate every table.
    return
