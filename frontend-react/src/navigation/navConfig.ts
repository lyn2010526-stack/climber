...
export const CORE_NAV_ITEMS_BASE: NavItem[] = [
  ...
  { id: 'factory', icon: Factory, label: 'Factory', group: 'main', keywords: '自主 自动执行' },
...
export const ALL_NAV_ITEMS_BASE: NavItem[] = [
  ...
  { id: 'factory', icon: Factory, label: 'Factory', group: 'main', keywords: 'auto agent execute 自主 自动执行' },
...
export const MOBILE_ADAPTED_PAGE_IDS: ReadonlySet<Page> = new Set<Page>([
  'dashboard', 'chat', 'tasks', 'factory', 'cluster', 'agents', 'apikeys', 'settings',
]);
