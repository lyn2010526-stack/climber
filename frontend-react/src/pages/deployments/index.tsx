...
import { fetchDeploymentss, createDeployments, updateDeployments, deleteDeployments } from '@/api/deployments'
...
export const DeploymentsPage: React.FC<DeploymentsPageProps> = ({ title }) => {
    ...
    const { data, isLoading, error } = useQuery({
        queryKey: ['deployments', page, pageSize, search, statusFilter, sortBy, sortOrder],
        queryFn: () => fetchDeploymentss({ page, pageSize, search, status: statusFilter, sortBy, sortOrder })
    })

    const createMutation = useMutation({
        mutationFn: createDeployments,
        onSuccess: () => {
    ...
    const updateMutation = useMutation({
        mutationFn: (data: Partial<Deployments>) => updateDeployments(editingId!, data),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['deployments'] })
    ...
    return (
        <div className='space-y-6 p-6'>
            <div className='flex items-center justify-between'>
                <h1 className='text-2xl font-bold'>{title || t('deployments.title')}</h1>
            ...
            <Modal isOpen={isCreateModalOpen} onClose={() => setIsCreateModalOpen(false)}>
                ...
                <ModalBody>
                    <p>{t('deployments.create_description')}</p>
                </ModalBody>
                <ModalFooter>
