...
import { fetchMonitorings, createMonitoring, updateMonitoring, deleteMonitoring } from '@/api/monitoring'
...
export const MonitoringPage: React.FC<MonitoringPageProps> = ({ title }) => {
    ...
    const { data, isLoading, error } = useQuery({
        queryKey: ['monitoring', page, pageSize, search, statusFilter, sortBy, sortOrder],
        queryFn: () => fetchMonitorings({ page, pageSize, search, status: statusFilter, sortBy, sortOrder })
    })

    const createMutation = useMutation({
        mutationFn: createMonitoring,
        onSuccess: () => {
    ...
    const updateMutation = useMutation({
        mutationFn: (data: Partial<Monitoring>) => updateMonitoring(editingId!, data),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['monitoring'] })
    ...
    return (
        <div className='space-y-6 p-6'>
            <div className='flex items-center justify-between'>
                <h1 className='text-2xl font-bold'>{title || t('monitoring.title')}</h1>
            ...
            <Modal isOpen={isCreateModalOpen} onClose={() => setIsCreateModalOpen(false)}>
                ...
                <ModalBody>
                    <p>{t('monitoring.create_description')}</p>
                </ModalBody>
                <ModalFooter>
