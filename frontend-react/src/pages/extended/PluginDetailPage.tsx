/* View plugin information and reviews */
...
export default function PluginDetailPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Plugin Details</h1>
        <p className="text-gray-600 mt-1">View plugin information and reviews.</p>
      </div>
