...
import { fetchHelps, createHelp, updateHelp, deleteHelp } from '@/api/help'
...
export const HelpPage: React.FC<HelpPageProps> = ({ title }) => {
    ...
    const { data, isLoading, error } = useQuery({
        queryKey: ['help', page, pageSize, search, statusFilter, sortBy, sortOrder],
        queryFn: () => fetchHelps({ page, pageSize, search, status: statusFilter, sortBy, sortOrder })
    })
    ...
    const updateMutation = useMutation({
        mutationFn: (data: Partial<Help>) => updateHelp(editingId!, data),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['help'] })
    ...
    return (
        <div className='space-y-6 p-6'>
            <div className='flex items-center justify-between'>
                <h1 className='text-2xl font-bold'>{title || t('help.title')}</h1>
