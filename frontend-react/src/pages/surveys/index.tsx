...
import { fetchSurveyss, createSurveys, updateSurveys, deleteSurveys } from '@/api/surveys'
...
export const SurveysPage: React.FC<SurveysPageProps> = ({ title }) => {
    ...
    const { data, isLoading, error } = useQuery({
        queryKey: ['surveys', page, pageSize, search, statusFilter, sortBy, sortOrder],
        queryFn: () => fetchSurveyss({ page, pageSize, search, status: statusFilter, sortBy, sortOrder })
    })

    const createMutation = useMutation({
        mutationFn: createSurveys,
        onSuccess: () => {
    ...
    const updateMutation = useMutation({
        mutationFn: (data: Partial<Surveys>) => updateSurveys(editingId!, data),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['surveys'] })
    ...
    return (
        <div className='space-y-6 p-6'>
            <div className='flex items-center justify-between'>
                <h1 className='text-2xl font-bold'>{title || t('surveys.title')}</h1>
            ...
            <Modal isOpen={isCreateModalOpen} onClose={() => setIsCreateModalOpen(false)}>
                ...
                <ModalBody>
                    <p>{t('surveys.create_description')}</p>
                </ModalBody>
                <ModalFooter>
