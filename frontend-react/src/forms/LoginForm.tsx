...
interface LoginFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: LoginFormData) => LoginFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const LoginForm: React.FC<LoginFormProps> = ({
    ...
    const [formData, setFormData] = useState<LoginFormData>(initialData as LoginFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as LoginFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
