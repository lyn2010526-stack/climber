...
interface PasswordFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: PasswordFormData) => PasswordFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const PasswordForm: React.FC<PasswordFormProps> = ({
    ...
    const [formData, setFormData] = useState<PasswordFormData>(initialData as PasswordFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as PasswordFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
