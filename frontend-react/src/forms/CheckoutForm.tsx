...
interface CheckoutFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: CheckoutFormData) => CheckoutFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const CheckoutForm: React.FC<CheckoutFormProps> = ({
    ...
    const [formData, setFormData] = useState<CheckoutFormData>(initialData as CheckoutFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as CheckoutFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
