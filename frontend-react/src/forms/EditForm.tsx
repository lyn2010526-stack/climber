...
interface EditFormProps {
    ...
    onSubmit: (data: EditFormData) => void | Promise<void>
    onCancel?: () => void
    onValidate?: (data: EditFormData) => EditFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const EditForm: React.FC<EditFormProps> = ({
    ...
    const [formData, setFormData] = useState<EditFormData>(initialData as EditFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as EditFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
