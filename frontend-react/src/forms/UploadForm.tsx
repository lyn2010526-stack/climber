...
interface UploadFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: UploadFormData) => UploadFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const UploadForm: React.FC<UploadFormProps> = ({
    ...
    const [formData, setFormData] = useState<UploadFormData>(initialData as UploadFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as UploadFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
