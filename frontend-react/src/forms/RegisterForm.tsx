...
interface RegisterFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: RegisterFormData) => RegisterFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const RegisterForm: React.FC<RegisterFormProps> = ({
    ...
    const [formData, setFormData] = useState<RegisterFormData>(initialData as RegisterFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as RegisterFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
