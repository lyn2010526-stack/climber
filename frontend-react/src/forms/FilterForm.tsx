...
interface FilterFormProps {
    ...
    onSubmit: (data: FilterFormData) => void | Promise<void>
    onCancel?: () => void
    onValidate?: (data: FilterFormData) => FilterFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const FilterForm: React.FC<FilterFormProps> = ({
    ...
    const [formData, setFormData] = useState<FilterFormData>(initialData as FilterFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as FilterFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
