...
interface DeleteFormProps {
    initialData?: Partial<DeleteFormData>
    onSubmit: (data: DeleteFormData) => void | Promise<void>
    onCancel?: () => void
    onValidate?: (data: DeleteFormData) => DeleteFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const DeleteForm: React.FC<DeleteFormProps> = ({
    ...
    const [formData, setFormData] = useState<DeleteFormData>(initialData as DeleteFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as DeleteFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
