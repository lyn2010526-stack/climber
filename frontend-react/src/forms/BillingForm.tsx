...
interface BillingFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: BillingFormData) => BillingFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const BillingForm: React.FC<BillingFormProps> = ({
    ...
    const [formData, setFormData] = useState<BillingFormData>(initialData as BillingFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as BillingFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
