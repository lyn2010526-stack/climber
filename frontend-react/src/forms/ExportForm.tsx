...
interface ExportFormProps {
    initialData?: Partial<ExportFormData>
    onSubmit: (data: ExportFormData) => void | Promise<void>
    onCancel?: () => void
    onValidate?: (data: ExportFormData) => ExportFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const ExportForm: React.FC<ExportFormProps> = ({
    ...
    const [formData, setFormData] = useState<ExportFormData>(initialData as ExportFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as ExportFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
