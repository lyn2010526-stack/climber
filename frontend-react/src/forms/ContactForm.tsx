...
interface ContactFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: ContactFormData) => ContactFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const ContactForm: React.FC<ContactFormProps> = ({
    ...
    const [formData, setFormData] = useState<ContactFormData>(initialData as ContactFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as ContactFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
