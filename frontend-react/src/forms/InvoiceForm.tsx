...
interface InvoiceFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: InvoiceFormData) => InvoiceFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const InvoiceForm: React.FC<InvoiceFormProps> = ({
    ...
    const [formData, setFormData] = useState<InvoiceFormData>(initialData as InvoiceFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as InvoiceFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
