...
interface ProfileFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: ProfileFormData) => ProfileFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const ProfileForm: React.FC<ProfileFormProps> = ({
    ...
    const [formData, setFormData] = useState<ProfileFormData>(initialData as ProfileFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as ProfileFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
