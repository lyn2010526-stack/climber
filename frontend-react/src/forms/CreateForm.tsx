...
interface CreateFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: CreateFormData) => CreateFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const CreateForm: React.FC<CreateFormProps> = ({
    ...
    const [formData, setFormData] = useState<CreateFormData>(initialData as CreateFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as CreateFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
