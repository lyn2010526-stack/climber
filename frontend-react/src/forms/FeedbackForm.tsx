...
interface FeedbackFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: FeedbackFormData) => FeedbackFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const FeedbackForm: React.FC<FeedbackFormProps> = ({
    ...
    const [formData, setFormData] = useState<FeedbackFormData>(initialData as FeedbackFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as FeedbackFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
