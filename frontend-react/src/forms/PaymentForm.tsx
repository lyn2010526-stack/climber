...
interface PaymentFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: PaymentFormData) => PaymentFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const PaymentForm: React.FC<PaymentFormProps> = ({
    ...
    const [formData, setFormData] = useState<PaymentFormData>(initialData as PaymentFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as PaymentFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
