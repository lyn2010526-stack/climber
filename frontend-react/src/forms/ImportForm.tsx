...
interface ImportFormProps {
    ...
    onSubmit: (data: ImportFormData) => void | Promise<void>
    onCancel?: () => void
    onValidate?: (data: ImportFormData) => ImportFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const ImportForm: React.FC<ImportFormProps> = ({
    ...
    const [formData, setFormData] = useState<ImportFormData>(initialData as ImportFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as ImportFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
