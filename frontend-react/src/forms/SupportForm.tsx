...
interface SupportFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: SupportFormData) => SupportFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const SupportForm: React.FC<SupportFormProps> = ({
    ...
    const [formData, setFormData] = useState<SupportFormData>(initialData as SupportFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as SupportFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
