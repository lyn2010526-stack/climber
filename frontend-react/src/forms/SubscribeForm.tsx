...
interface SubscribeFormErrors {
    [key: string]: string | undefined
}


interface SubscribeFormProps {
    initialData?: Partial<SubscribeFormData>
    onSubmit: (data: SubscribeFormData) => void | Promise<void>
    onCancel?: () => void
    onValidate?: (data: SubscribeFormData) => SubscribeFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const SubscribeForm: React.FC<SubscribeFormProps> = ({
    ...
    const [formData, setFormData] = useState<SubscribeFormData>(initialData as SubscribeFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as SubscribeFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
