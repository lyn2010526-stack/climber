...
interface QuizFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: QuizFormData) => QuizFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const QuizForm: React.FC<QuizFormProps> = ({
    ...
    const [formData, setFormData] = useState<QuizFormData>(initialData as QuizFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as QuizFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
