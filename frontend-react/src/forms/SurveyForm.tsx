...
interface SurveyFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: SurveyFormData) => SurveyFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const SurveyForm: React.FC<SurveyFormProps> = ({
    ...
    const [formData, setFormData] = useState<SurveyFormData>(initialData as SurveyFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as SurveyFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
