...
interface ShippingFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: ShippingFormData) => ShippingFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const ShippingForm: React.FC<ShippingFormProps> = ({
    ...
    const [formData, setFormData] = useState<ShippingFormData>(initialData as ShippingFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as ShippingFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
