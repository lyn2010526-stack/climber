...
interface WizardFormProps {
    ...
    onCancel?: () => void
    onValidate?: (data: WizardFormData) => WizardFormErrors
    loading?: boolean
    disabled?: boolean
    submitLabel?: string
    cancelLabel?: string
...
export const WizardForm: React.FC<WizardFormProps> = ({
    ...
    const [formData, setFormData] = useState<WizardFormData>(initialData as WizardFormData)
    ...
    const handleReset = useCallback(() => {
        setFormData(initialData as WizardFormData)
        setErrors({})
        setTouched({})
    }, [initialData])
