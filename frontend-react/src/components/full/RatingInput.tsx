...
const RatingInputContext = createContext<RatingInputState | null>(null);
...
export default function RatingInput(props: RatingInputProps) {
  ...
  const [state, setState] = useState<RatingInputState>({
    focused: false,
    hovered: false,
    active: false,
    value: defaultValue,
  ...
  return (
    <RatingInputContext.Provider value={state}>
      <div
        ref={containerRef}
