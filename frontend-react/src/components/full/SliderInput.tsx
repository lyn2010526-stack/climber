...
const SliderInputContext = createContext<SliderInputState | null>(null);
...
export default function SliderInput(props: SliderInputProps) {
  ...
  const [state, setState] = useState<SliderInputState>({
    focused: false,
    hovered: false,
    active: false,
    value: defaultValue,
  ...
  return (
    <SliderInputContext.Provider value={state}>
      <div
        ref={containerRef}
