...
const CheckboxFieldContext = createContext<CheckboxFieldState | null>(null);
...
export default function CheckboxField(props: CheckboxFieldProps) {
  ...
  const [state, setState] = useState<CheckboxFieldState>({
    focused: false,
    hovered: false,
    active: false,
    value: defaultValue,
  ...
  return (
    <CheckboxFieldContext.Provider value={state}>
      <div
        ref={containerRef}
