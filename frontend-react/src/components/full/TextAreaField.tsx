...
const TextAreaFieldContext = createContext<TextAreaFieldState | null>(null);
...
export default function TextAreaField(props: TextAreaFieldProps) {
  ...
  const [state, setState] = useState<TextAreaFieldState>({
    focused: false,
    hovered: false,
    active: false,
    value: defaultValue,
  ...
  return (
    <TextAreaFieldContext.Provider value={state}>
      <div
        ref={containerRef}
