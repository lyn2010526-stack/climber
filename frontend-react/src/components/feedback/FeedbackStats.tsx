  ...
  if (compact) {
    return (
      <div className="flex items-center gap-3 text-xs">
        ...
        <span className="text-gray-500">{approvalPercent}%</span>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-1.5">
          ...
          <span className="text-sm font-semibold text-gray-100">{approvalPercent}%</span>
        </div>
      ...
      <div className="flex gap-4">
        <div className="flex-1 bg-green-500/10 border border-success/20 rounded-lg px-3 py-2 text-center">
          ...
          <div className="text-sm font-semibold text-gray-100">{stats.up_count}</div>
           <div className="text-[10px] text-gray-500">有用</div>
        </div>
        <div className="flex-1 bg-red-500/10 border border-error/20 rounded-lg px-3 py-2 text-center">
          ...
          <div className="text-sm font-semibold text-gray-100">{stats.down_count}</div>
           <div className="text-[10px] text-gray-500">没用</div>
        </div>
      </div>
          ...
          <div className="space-y-1.5">
            {reasons.map(([reason, count]) => (
              <div key={reason} className="flex items-center gap-2">
                <span className="text-[11px] text-gray-500 w-24 truncate">
