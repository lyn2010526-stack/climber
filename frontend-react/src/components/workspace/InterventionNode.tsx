  ...
  return (
    <div className="mx-auto max-w-[80%] my-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-800 border border-blue-500/20 rounded-full">
      ...
      <div className="mt-2 p-3 bg-gray-800 border border-blue-500/10 rounded-xl">
        <div className="flex items-start gap-2">
          <div className="w-6 h-6 rounded-full bg-blue-600/10 flex items-center justify-center shrink-0">
            <User size={12} className="text-blue-400" />
          </div>
          <div className="flex-1">
            <p className="text-xs text-gray-100">{userMessage}</p>
