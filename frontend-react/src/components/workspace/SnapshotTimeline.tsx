    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <button
          ...
          className="flex items-center gap-1.5 text-xs font-medium text-gray-400 hover:text-gray-100"
        >
      ...
      {expanded && (
        <div className="space-y-1 max-h-48 overflow-y-auto">
          {snapshots.length === 0 && (
            <p className="text-[10px] text-gray-500 text-center py-3">No snapshots saved</p>
          )}
          {snapshots.map((snap, i) => (
            ...
            >
              <div className="flex flex-col items-center">
                ...
                {i < snapshots.length - 1 && <div className="w-0.5 h-3 bg-gray-700" />}
              </div>
              <div className="flex-1 min-w-0">
                <span className="text-[10px] text-gray-100 truncate block">{snap.label}</span>
