    ...
    <div className={inDrawer ? "w-full flex flex-col" : "w-60 flex flex-col shrink-0"} style={inDrawer ? {} : {
      ...
      <div className="p-2 space-y-1.5" style={{ borderBottom: '1px solid var(--color-border-subtle)' }}>
        ...
        <button
          ...
          className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-left text-[11px] transition-colors hover:bg-[var(--color-bg-surface-2)]"
        ...
        {createOptionsOpen && <div className="grid grid-cols-1 gap-1.5 rounded-lg p-2" style={{ backgroundColor: 'var(--color-bg-surface-2)' }}>
          <div>
            {agentsError && (
