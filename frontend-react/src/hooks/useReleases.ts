...
type ReleasesHookReturn = ReleasesState & ReleasesActions


export function useReleases(initialFilters?: Record<string, any>): ReleasesHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['releases', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
