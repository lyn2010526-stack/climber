...
type DecisionsHookReturn = DecisionsState & DecisionsActions


export function useDecisions(initialFilters?: Record<string, any>): DecisionsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['decisions', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
