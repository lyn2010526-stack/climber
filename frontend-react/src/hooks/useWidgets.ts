...
type WidgetsHookReturn = WidgetsState & WidgetsActions


export function useWidgets(initialFilters?: Record<string, any>): WidgetsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['widgets', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
