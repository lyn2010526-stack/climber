...
export function useIntersection<T = any>(
    key: string,
    fetcher: () => Promise<T>,
    config: IntersectionConfig = {}
): IntersectionState<T> & IntersectionActions {
    const {
        enabled = true,
        immediate = true,
        interval,
    ...
    const [state, setState] = useState<IntersectionState<T>>({
        data: null,
        loading: immediate,
        error: null,
        stale: false,
