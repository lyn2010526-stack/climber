...
type ChartsHookReturn = ChartsState & ChartsActions


export function useCharts(initialFilters?: Record<string, any>): ChartsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['charts', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
