...
type BranchesHookReturn = BranchesState & BranchesActions


export function useBranches(initialFilters?: Record<string, any>): BranchesHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['branches', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
