...
type CommentsHookReturn = CommentsState & CommentsActions


export function useComments(initialFilters?: Record<string, any>): CommentsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['comments', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
