...
type NotificationsHookReturn = NotificationsState & NotificationsActions


export function useNotifications(initialFilters?: Record<string, any>): NotificationsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['notifications', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
