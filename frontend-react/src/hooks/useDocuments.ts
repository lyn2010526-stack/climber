...
type DocumentsHookReturn = DocumentsState & DocumentsActions


export function useDocuments(initialFilters?: Record<string, any>): DocumentsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['documents', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
