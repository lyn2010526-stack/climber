...
type ProjectsHookReturn = ProjectsState & ProjectsActions


export function useProjects(initialFilters?: Record<string, any>): ProjectsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['projects', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
