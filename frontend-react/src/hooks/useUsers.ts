...
type UsersHookReturn = UsersState & UsersActions


export function useUsers(initialFilters?: Record<string, any>): UsersHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['users', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
