...
type GoalsHookReturn = GoalsState & GoalsActions


export function useGoals(initialFilters?: Record<string, any>): GoalsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['goals', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
