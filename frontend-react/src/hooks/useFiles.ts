...
type FilesHookReturn = FilesState & FilesActions


export function useFiles(initialFilters?: Record<string, any>): FilesHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['files', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
