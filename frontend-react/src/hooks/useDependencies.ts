...
type DependenciesHookReturn = DependenciesState & DependenciesActions


export function useDependencies(initialFilters?: Record<string, any>): DependenciesHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['dependencies', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
    ...
    const createMutation = useMutation({
        mutationFn: async (data: any) => {
            ...
            const response = await apiClient.post('/dependencies', data)
            return response.data
        },
        onSuccess: () => {
    ...
    const updateMutation = useMutation({
        mutationFn: async ({ id, data }: { id: number; data: any }) => {
            ...
            const response = await apiClient.put('/dependencies/' + id, data)
            return response.data
        },
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['dependencies'] })
