...
type IssuesHookReturn = IssuesState & IssuesActions


export function useIssues(initialFilters?: Record<string, any>): IssuesHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['issues', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
