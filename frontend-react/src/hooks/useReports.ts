...
type ReportsHookReturn = ReportsState & ReportsActions


export function useReports(initialFilters?: Record<string, any>): ReportsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['reports', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
