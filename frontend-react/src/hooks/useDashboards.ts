...
type DashboardsHookReturn = DashboardsState & DashboardsActions


export function useDashboards(initialFilters?: Record<string, any>): DashboardsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['dashboards', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
