...
type TeamsHookReturn = TeamsState & TeamsActions


export function useTeams(initialFilters?: Record<string, any>): TeamsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['teams', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
