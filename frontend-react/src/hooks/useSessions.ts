...
type SessionsHookReturn = SessionsState & SessionsActions


export function useSessions(initialFilters?: Record<string, any>): SessionsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['sessions', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
