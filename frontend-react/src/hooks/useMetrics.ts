...
type MetricsHookReturn = MetricsState & MetricsActions


export function useMetrics(initialFilters?: Record<string, any>): MetricsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['metrics', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
