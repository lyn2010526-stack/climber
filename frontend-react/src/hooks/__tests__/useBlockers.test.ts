...
describe('useBlockers', () => {
  ...
  it('create posts to /blockers', async () => {
    const { apiClient } = await import('@/lib/api-client');
    ...
    expect(apiClient.post).toHaveBeenCalledWith('/blockers', { name: 'New Item' });
  });

  it('update puts to /blockers/{id}', async () => {
    const { apiClient } = await import('@/lib/api-client');
    ...
    expect(apiClient.put).toHaveBeenCalledWith('/blockers/1', { name: 'Updated' });
  });

  it('remove deletes /blockers/{id}', async () => {
    const { apiClient } = await import('@/lib/api-client');
    ...
    expect(apiClient.delete).toHaveBeenCalledWith('/blockers/1');
  });
