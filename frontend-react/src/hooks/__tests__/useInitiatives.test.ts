...
describe('useInitiatives', () => {
  ...
  it('create posts to /initiatives', async () => {
    const { apiClient } = await import('@/lib/api-client');
    ...
    expect(apiClient.post).toHaveBeenCalledWith('/initiatives', { name: 'New Item' });
  });

  it('update puts to /initiatives/{id}', async () => {
    const { apiClient } = await import('@/lib/api-client');
    ...
    expect(apiClient.put).toHaveBeenCalledWith('/initiatives/1', { name: 'Updated' });
  });

  it('remove deletes /initiatives/{id}', async () => {
    const { apiClient } = await import('@/lib/api-client');
    ...
    expect(apiClient.delete).toHaveBeenCalledWith('/initiatives/1');
  });
