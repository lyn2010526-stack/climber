...
type TasksHookReturn = TasksState & TasksActions


export function useTasks(initialFilters?: Record<string, any>): TasksHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['tasks', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
