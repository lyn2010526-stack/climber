...
type ActionsHookReturn = ActionsState & ActionsActions


export function useActions(initialFilters?: Record<string, any>): ActionsHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['actions', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
