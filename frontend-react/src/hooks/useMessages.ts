...
type MessagesHookReturn = MessagesState & MessagesActions


export function useMessages(initialFilters?: Record<string, any>): MessagesHookReturn {
    ...
    const { data, isLoading, error, refetch } = useQuery({
        queryKey: ['messages', state.page, state.pageSize, state.filters, state.sortBy, state.sortOrder],
        queryFn: async () => {
