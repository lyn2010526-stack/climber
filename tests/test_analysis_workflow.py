...
class TestAnalysisWorkflowEngine:
    """Tests for workflow engine."""

    def test_create_workflow(self):
        engine = AnalysisWorkflowEngine()
        wf = AnalysisWorkflowDefinition(name='test')
    ...
    def test_list_workflows(self):
        engine = AnalysisWorkflowEngine()
        engine.create_workflow(AnalysisWorkflowDefinition(name='wf1'))
        engine.create_workflow(AnalysisWorkflowDefinition(name='wf2'))
        result = engine.list_workflows()
        assert len(result) == 2

    def test_delete_workflow(self):
        engine = AnalysisWorkflowEngine()
        wid = engine.create_workflow(AnalysisWorkflowDefinition(name='test'))
    ...
    async def test_execute_workflow(self):
        ...
        step = AnalysisWorkflowStep(name='step1', action='mock')
        wf = AnalysisWorkflowDefinition(name='test', steps=[step])
        wid = engine.create_workflow(wf)
    ...
    def test_pause_execution(self):
        engine = AnalysisWorkflowEngine()
        execution = AnalysisWorkflowExecution(status='running')
    ...
    def test_get_stats(self):
        engine = AnalysisWorkflowEngine()
        engine.create_workflow(AnalysisWorkflowDefinition(name='test'))
