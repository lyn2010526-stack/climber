"""Tests for question_answering ML model."""


from app.ml.question_answering_model import (
    QuestionAnsweringMLModel,
)


class TestQuestionAnsweringMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = QuestionAnsweringMLModel()
