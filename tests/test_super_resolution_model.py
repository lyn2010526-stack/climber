"""Tests for super_resolution ML model."""


from app.ml.super_resolution_model import (
    SuperResolutionMLModel,
)


class TestSuperResolutionMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = SuperResolutionMLModel()
