"""Tests for speech_recognition ML model."""


from app.ml.speech_recognition_model import (
    SpeechRecognitionMLModel,
)


class TestSpeechRecognitionMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = SpeechRecognitionMLModel()
