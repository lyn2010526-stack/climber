"""Tests for depth_estimation ML model."""


from app.ml.depth_estimation_model import (
    DepthEstimationMLModel,
)


class TestDepthEstimationMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = DepthEstimationMLModel()
