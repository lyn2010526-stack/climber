"""Tests for anomaly_detection ML model."""


from app.ml.anomaly_detection_model import (
    AnomalyDetectionMLModel,
)


class TestAnomalyDetectionMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = AnomalyDetectionMLModel()
