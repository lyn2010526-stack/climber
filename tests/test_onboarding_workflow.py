...
class TestOnboardingWorkflowEngine:
    ...
    def test_create_workflow(self):
        ...
        wf = OnboardingWorkflowDefinition(name='test')
    ...
    def test_list_workflows(self):
        engine = OnboardingWorkflowEngine()
        engine.create_workflow(OnboardingWorkflowDefinition(name='wf1'))
        engine.create_workflow(OnboardingWorkflowDefinition(name='wf2'))
        result = engine.list_workflows()
        assert len(result) == 2

    def test_delete_workflow(self):
        engine = OnboardingWorkflowEngine()
        wid = engine.create_workflow(OnboardingWorkflowDefinition(name='test'))
    ...
    async def test_execute_workflow(self):
        ...
        step = OnboardingWorkflowStep(name='step1', action='mock')
        wf = OnboardingWorkflowDefinition(name='test', steps=[step])
        wid = engine.create_workflow(wf)
    ...
    def test_pause_execution(self):
        engine = OnboardingWorkflowEngine()
        execution = OnboardingWorkflowExecution(status='running')
    ...
    def test_get_stats(self):
        engine = OnboardingWorkflowEngine()
        engine.create_workflow(OnboardingWorkflowDefinition(name='test'))
