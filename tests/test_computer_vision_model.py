"""Tests for computer_vision ML model."""


from app.ml.computer_vision_model import (
    ComputerVisionMLModel,
)


class TestComputerVisionMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = ComputerVisionMLModel()
