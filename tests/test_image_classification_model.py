"""Tests for image_classification ML model."""


from app.ml.image_classification_model import (
    ImageClassificationMLModel,
)


class TestImageClassificationMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = ImageClassificationMLModel()
