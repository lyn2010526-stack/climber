"""Tests for text_generation ML model."""


from app.ml.text_generation_model import (
    TextGenerationMLModel,
)


class TestTextGenerationMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = TextGenerationMLModel()
