"""Tests for music_generation ML model."""


from app.ml.music_generation_model import (
    MusicGenerationMLModel,
)


class TestMusicGenerationMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = MusicGenerationMLModel()
