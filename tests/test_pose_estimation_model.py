"""Tests for pose_estimation ML model."""


from app.ml.pose_estimation_model import (
    PoseEstimationMLModel,
)


class TestPoseEstimationMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = PoseEstimationMLModel()
