"""Tests for action_recognition ML model."""


from app.ml.action_recognition_model import (
    ActionRecognitionMLModel,
)


class TestActionRecognitionMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = ActionRecognitionMLModel()
