"""Tests for object_detection ML model."""


from app.ml.object_detection_model import (
    ObjectDetectionMLModel,
)


class TestObjectDetectionMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = ObjectDetectionMLModel()
