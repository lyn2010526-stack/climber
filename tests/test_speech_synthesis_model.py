"""Tests for speech_synthesis ML model."""


from app.ml.speech_synthesis_model import (
    SpeechSynthesisMLModel,
)


class TestSpeechSynthesisMLModel:
    """Tests for ML model."""

    def test_create_model(self):
        model = SpeechSynthesisMLModel()
