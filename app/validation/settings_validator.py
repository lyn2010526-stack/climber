...
class SettingsValidationResult:
    ...
    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(SettingsValidationError(field=field, message=message, code=code))
...
class SettingsValidator:
    ...
    def validate(self, data: dict[str, Any]) -> SettingsValidationResult:
        """Validate data."""
