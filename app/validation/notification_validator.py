...
class NotificationValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[NotificationValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(NotificationValidationError(field=field, message=message, code=code))
...
class NotificationValidator:
    ...
    def validate(self, data: dict[str, Any]) -> NotificationValidationResult:
        """Validate data."""
...
class NotificationFieldValidator:
    """Field validator."""
