...
class ResponseValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[ResponseValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(ResponseValidationError(field=field, message=message, code=code))
...
class ResponseValidator:
    ...
    def validate(self, data: dict[str, Any]) -> ResponseValidationResult:
        """Validate data."""
