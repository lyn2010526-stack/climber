...
class PreferencesValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[PreferencesValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(PreferencesValidationError(field=field, message=message, code=code))
...
class PreferencesValidator:
    ...
    def validate(self, data: dict[str, Any]) -> PreferencesValidationResult:
        """Validate data."""
        result = PreferencesValidationResult()
...
class PreferencesFieldValidator:
    """Field validator."""
