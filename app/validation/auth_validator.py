...
class AuthValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[AuthValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(AuthValidationError(field=field, message=message, code=code))
...
class AuthValidator:
    ...
    def validate(self, data: dict[str, Any]) -> AuthValidationResult:
        """Validate data."""
