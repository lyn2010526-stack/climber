...
class SessionValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[SessionValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(SessionValidationError(field=field, message=message, code=code))
...
class SessionValidator:
    ...
    def validate(self, data: dict[str, Any]) -> SessionValidationResult:
        """Validate data."""
