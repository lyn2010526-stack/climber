...
class SubscriptionValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[SubscriptionValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(SubscriptionValidationError(field=field, message=message, code=code))
...
class SubscriptionValidator:
    ...
    def validate(self, data: dict[str, Any]) -> SubscriptionValidationResult:
        """Validate data."""
