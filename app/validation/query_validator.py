...
class QueryValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[QueryValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(QueryValidationError(field=field, message=message, code=code))
...
class QueryValidator:
    ...
    def validate(self, data: dict[str, Any]) -> QueryValidationResult:
        """Validate data."""
