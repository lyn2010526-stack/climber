...
class DownloadValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[DownloadValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(DownloadValidationError(field=field, message=message, code=code))
...
class DownloadValidator:
    ...
    def validate(self, data: dict[str, Any]) -> DownloadValidationResult:
        """Validate data."""
