...
class ParamsValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[ParamsValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(ParamsValidationError(field=field, message=message, code=code))
...
class ParamsValidator:
    ...
    def validate(self, data: dict[str, Any]) -> ParamsValidationResult:
        """Validate data."""
        result = ParamsValidationResult()
