...
class AccountValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[AccountValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(AccountValidationError(field=field, message=message, code=code))
...
class AccountValidator:
    ...
    def validate(self, data: dict[str, Any]) -> AccountValidationResult:
        """Validate data."""
