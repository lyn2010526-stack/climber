...
class TokenValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[TokenValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(TokenValidationError(field=field, message=message, code=code))
...
class TokenValidator:
    ...
    def validate(self, data: dict[str, Any]) -> TokenValidationResult:
        """Validate data."""
