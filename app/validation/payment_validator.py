...
class PaymentValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[PaymentValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(PaymentValidationError(field=field, message=message, code=code))
...
class PaymentValidator:
    ...
    def validate(self, data: dict[str, Any]) -> PaymentValidationResult:
        """Validate data."""
