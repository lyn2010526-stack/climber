...
class BodyValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[BodyValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(BodyValidationError(field=field, message=message, code=code))
...
class BodyValidator:
    ...
    def validate(self, data: dict[str, Any]) -> BodyValidationResult:
        """Validate data."""
