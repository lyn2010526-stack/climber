...
class CredentialsValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[CredentialsValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(CredentialsValidationError(field=field, message=message, code=code))
...
class CredentialsValidator:
    ...
    def validate(self, data: dict[str, Any]) -> CredentialsValidationResult:
        """Validate data."""
...
class CredentialsFieldValidator:
    """Field validator."""
