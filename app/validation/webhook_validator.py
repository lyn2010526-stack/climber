...
class WebhookValidationResult:
    """Validation result."""
    valid: bool = True
    errors: list[WebhookValidationError] = field(default_factory=list)

    def add_error(self, field: str, message: str, code: str = 'invalid') -> None:
        self.valid = False
        self.errors.append(WebhookValidationError(field=field, message=message, code=code))
...
class WebhookValidator:
    ...
    def validate(self, data: dict[str, Any]) -> WebhookValidationResult:
        """Validate data."""
