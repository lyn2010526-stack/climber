"""Domain model: feature - Business domain entities."""
...
class FeatureEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return FeatureEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> FeatureEntity:
        """Create entity from dict."""
        return FeatureEntity(**{k: v for k, v in data.items() if hasattr(FeatureEntity, k)})


class FeatureEntityRepository:
    """Entity repository."""
    ...
    def save(self, entity: FeatureEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> FeatureEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: FeatureEntity) -> None:
        """Update indexes."""
...
class FeatureValidator:
    ...
    @staticmethod
    def validate(entity: FeatureEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: FeatureEntity) -> bool:
        """Check if entity is valid."""
        return len(FeatureValidator.validate(entity)) == 0
