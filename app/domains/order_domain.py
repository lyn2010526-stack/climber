"""Domain model: order - Business domain entities."""
...
class OrderEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return OrderEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> OrderEntity:
        """Create entity from dict."""
        return OrderEntity(**{k: v for k, v in data.items() if hasattr(OrderEntity, k)})
...
class OrderEntityRepository:
    ...
    def __init__(self):
        self._entities: dict[str, OrderEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: OrderEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> OrderEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: OrderEntity) -> None:
        """Update indexes."""
...
class OrderValidator:
    ...
    @staticmethod
    def validate(entity: OrderEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: OrderEntity) -> bool:
        """Check if entity is valid."""
        return len(OrderValidator.validate(entity)) == 0
