"""Domain model: inventory - Business domain entities."""
...
class InventoryEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return InventoryEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> InventoryEntity:
        """Create entity from dict."""
        return InventoryEntity(**{k: v for k, v in data.items() if hasattr(InventoryEntity, k)})
...
class InventoryEntityRepository:
    ...
    def __init__(self):
        self._entities: dict[str, InventoryEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: InventoryEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> InventoryEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: InventoryEntity) -> None:
        """Update indexes."""
...
class InventoryValidator:
    ...
    @staticmethod
    def validate(entity: InventoryEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: InventoryEntity) -> bool:
        """Check if entity is valid."""
        return len(InventoryValidator.validate(entity)) == 0
