"""Domain model: customer - Business domain entities."""
...
class CustomerEntityType(StrEnum):
    """Entity type enum."""
...
class CustomerEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return CustomerEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> CustomerEntity:
        """Create entity from dict."""
        return CustomerEntity(**{k: v for k, v in data.items() if hasattr(CustomerEntity, k)})
...
class CustomerEntityRepository:
    ...
    def __init__(self):
        self._entities: dict[str, CustomerEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: CustomerEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> CustomerEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: CustomerEntity) -> None:
        """Update indexes."""
...
class CustomerValidator:
    ...
    @staticmethod
    def validate(entity: CustomerEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: CustomerEntity) -> bool:
        """Check if entity is valid."""
        return len(CustomerValidator.validate(entity)) == 0
