"""Domain model: tax - Business domain entities."""
...
class TaxEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return TaxEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> TaxEntity:
        """Create entity from dict."""
        return TaxEntity(**{k: v for k, v in data.items() if hasattr(TaxEntity, k)})
...
class TaxEntityRepository:
    ...
    def __init__(self):
        self._entities: dict[str, TaxEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: TaxEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> TaxEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: TaxEntity) -> None:
        """Update indexes."""
...
class TaxValidator:
    ...
    @staticmethod
    def validate(entity: TaxEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: TaxEntity) -> bool:
        """Check if entity is valid."""
        return len(TaxValidator.validate(entity)) == 0
