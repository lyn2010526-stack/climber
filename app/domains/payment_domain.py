"""Domain model: payment - Business domain entities."""
...
class PaymentEntityType(StrEnum):
    """Entity type enum."""
...
class PaymentEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return PaymentEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> PaymentEntity:
        """Create entity from dict."""
        return PaymentEntity(**{k: v for k, v in data.items() if hasattr(PaymentEntity, k)})
...
class PaymentEntityRepository:
    ...
    def __init__(self):
        self._entities: dict[str, PaymentEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: PaymentEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> PaymentEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: PaymentEntity) -> None:
        """Update indexes."""
...
class PaymentValidator:
    ...
    @staticmethod
    def validate(entity: PaymentEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: PaymentEntity) -> bool:
        """Check if entity is valid."""
        return len(PaymentValidator.validate(entity)) == 0
