"""Domain model: plan - Business domain entities."""
...
class PlanEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return PlanEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> PlanEntity:
        """Create entity from dict."""
        return PlanEntity(**{k: v for k, v in data.items() if hasattr(PlanEntity, k)})


class PlanEntityRepository:
    """Entity repository."""

    def __init__(self):
        self._entities: dict[str, PlanEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: PlanEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> PlanEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: PlanEntity) -> None:
        """Update indexes."""
...
class PlanValidator:
    ...
    @staticmethod
    def validate(entity: PlanEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: PlanEntity) -> bool:
        """Check if entity is valid."""
        return len(PlanValidator.validate(entity)) == 0
