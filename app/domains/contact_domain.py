"""Domain model: contact - Business domain entities."""
...
class ContactEntityType(StrEnum):
    """Entity type enum."""
...
class ContactEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return ContactEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> ContactEntity:
        """Create entity from dict."""
        return ContactEntity(**{k: v for k, v in data.items() if hasattr(ContactEntity, k)})
...
class ContactEntityRepository:
    ...
    def __init__(self):
        self._entities: dict[str, ContactEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: ContactEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> ContactEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: ContactEntity) -> None:
        """Update indexes."""
...
class ContactValidator:
    ...
    @staticmethod
    def validate(entity: ContactEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: ContactEntity) -> bool:
        """Check if entity is valid."""
        return len(ContactValidator.validate(entity)) == 0
