"""Domain model: account - Business domain entities."""
...
class AccountEntityType(StrEnum):
    """Entity type enum."""
...
class AccountEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return AccountEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> AccountEntity:
        """Create entity from dict."""
        return AccountEntity(**{k: v for k, v in data.items() if hasattr(AccountEntity, k)})
...
class AccountEntityRepository:
    ...
    def __init__(self):
        self._entities: dict[str, AccountEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: AccountEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> AccountEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: AccountEntity) -> None:
        """Update indexes."""
...
class AccountValidator:
    ...
    @staticmethod
    def validate(entity: AccountEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: AccountEntity) -> bool:
        """Check if entity is valid."""
        return len(AccountValidator.validate(entity)) == 0
