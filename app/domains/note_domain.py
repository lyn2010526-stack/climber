"""Domain model: note - Business domain entities."""
...
class NoteEntityFactory:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """Create new entity."""
        return NoteEntity(name=name, entity_type=entity_type, **kwargs)

    @staticmethod
    def create_from_dict(data: dict[str, Any]) -> NoteEntity:
        """Create entity from dict."""
        return NoteEntity(**{k: v for k, v in data.items() if hasattr(NoteEntity, k)})
...
class NoteEntityRepository:
    ...
    def __init__(self):
        self._entities: dict[str, NoteEntity] = {}
        self._indexes: dict[str, dict[str, set[str]]] = {}

    def save(self, entity: NoteEntity) -> str:
        """Save entity."""
    ...
    def find_by_id(self, entity_id: str) -> NoteEntity | None:
        """Find by ID."""
    ...
    def _update_indexes(self, entity: NoteEntity) -> None:
        """Update indexes."""
...
class NoteValidator:
    ...
    @staticmethod
    def validate(entity: NoteEntity) -> list[str]:
        """Validate entity."""
        errors = []
        if not entity.name:
    ...
    @staticmethod
    def is_valid(entity: NoteEntity) -> bool:
        """Check if entity is valid."""
        return len(NoteValidator.validate(entity)) == 0
