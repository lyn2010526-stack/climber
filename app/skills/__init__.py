...
from app.skills.registry import SkillRegistry as _NewSkillRegistry, SkillInfo as _NewSkillInfo
from app.skills.registry import SkillCategory as _NewSkillCategory


class SkillRegistry(_NewSkillRegistry):
...
- Recommend upgrades, replacements, removals""",
        ...
        for info in builtins:
            self.register(info, handler_map[info.id])
