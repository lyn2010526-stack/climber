"""Configuration: tracing - App configuration."""
...
class TracingEnvironment(StrEnum):
    """Environment enum."""
...
class TracingAppConfig:
    ...
    database: TracingDatabaseConfig = field(default_factory=TracingDatabaseConfig)
    cache: TracingCacheConfig = field(default_factory=TracingCacheConfig)
    auth: TracingAuthConfig = field(default_factory=TracingAuthConfig)
    logging: TracingLoggingConfig = field(default_factory=TracingLoggingConfig)
    server: TracingServerConfig = field(default_factory=TracingServerConfig)
    email: TracingEmailConfig = field(default_factory=TracingEmailConfig)
    storage: TracingStorageConfig = field(default_factory=TracingStorageConfig)
    features: TracingFeatureFlags = field(default_factory=TracingFeatureFlags)

    @classmethod
    def from_env(cls) -> TracingAppConfig:
