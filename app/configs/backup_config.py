"""Configuration: backup - App configuration."""
...
class BackupAppConfig:
    ...
    database: BackupDatabaseConfig = field(default_factory=BackupDatabaseConfig)
    cache: BackupCacheConfig = field(default_factory=BackupCacheConfig)
    auth: BackupAuthConfig = field(default_factory=BackupAuthConfig)
    logging: BackupLoggingConfig = field(default_factory=BackupLoggingConfig)
    server: BackupServerConfig = field(default_factory=BackupServerConfig)
    email: BackupEmailConfig = field(default_factory=BackupEmailConfig)
    storage: BackupStorageConfig = field(default_factory=BackupStorageConfig)
    features: BackupFeatureFlags = field(default_factory=BackupFeatureFlags)

    @classmethod
    def from_env(cls) -> BackupAppConfig:
