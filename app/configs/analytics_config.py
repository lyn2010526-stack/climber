"""Configuration: analytics - App configuration."""
...
class AnalyticsEnvironment(StrEnum):
    """Environment enum."""
...
class AnalyticsAppConfig:
    ...
    database: AnalyticsDatabaseConfig = field(default_factory=AnalyticsDatabaseConfig)
    cache: AnalyticsCacheConfig = field(default_factory=AnalyticsCacheConfig)
    auth: AnalyticsAuthConfig = field(default_factory=AnalyticsAuthConfig)
    logging: AnalyticsLoggingConfig = field(default_factory=AnalyticsLoggingConfig)
    server: AnalyticsServerConfig = field(default_factory=AnalyticsServerConfig)
    email: AnalyticsEmailConfig = field(default_factory=AnalyticsEmailConfig)
    storage: AnalyticsStorageConfig = field(default_factory=AnalyticsStorageConfig)
    features: AnalyticsFeatureFlags = field(default_factory=AnalyticsFeatureFlags)

    @classmethod
    def from_env(cls) -> AnalyticsAppConfig:
