"""Configuration: queue - App configuration."""
...
class QueueEnvironment(StrEnum):
    """Environment enum."""
...
class QueueAppConfig:
    ...
    database: QueueDatabaseConfig = field(default_factory=QueueDatabaseConfig)
    cache: QueueCacheConfig = field(default_factory=QueueCacheConfig)
    auth: QueueAuthConfig = field(default_factory=QueueAuthConfig)
    logging: QueueLoggingConfig = field(default_factory=QueueLoggingConfig)
    server: QueueServerConfig = field(default_factory=QueueServerConfig)
    email: QueueEmailConfig = field(default_factory=QueueEmailConfig)
    storage: QueueStorageConfig = field(default_factory=QueueStorageConfig)
    features: QueueFeatureFlags = field(default_factory=QueueFeatureFlags)

    @classmethod
    def from_env(cls) -> QueueAppConfig:
