"""Configuration: cors - App configuration."""
...
class CorsAppConfig:
    ...
    database: CorsDatabaseConfig = field(default_factory=CorsDatabaseConfig)
    cache: CorsCacheConfig = field(default_factory=CorsCacheConfig)
    auth: CorsAuthConfig = field(default_factory=CorsAuthConfig)
    logging: CorsLoggingConfig = field(default_factory=CorsLoggingConfig)
    server: CorsServerConfig = field(default_factory=CorsServerConfig)
    email: CorsEmailConfig = field(default_factory=CorsEmailConfig)
    storage: CorsStorageConfig = field(default_factory=CorsStorageConfig)
    features: CorsFeatureFlags = field(default_factory=CorsFeatureFlags)

    @classmethod
    def from_env(cls) -> CorsAppConfig:
