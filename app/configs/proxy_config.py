"""Configuration: proxy - App configuration."""
...
class ProxyEnvironment(StrEnum):
    """Environment enum."""
...
class ProxyAppConfig:
    ...
    database: ProxyDatabaseConfig = field(default_factory=ProxyDatabaseConfig)
    cache: ProxyCacheConfig = field(default_factory=ProxyCacheConfig)
    auth: ProxyAuthConfig = field(default_factory=ProxyAuthConfig)
    logging: ProxyLoggingConfig = field(default_factory=ProxyLoggingConfig)
    server: ProxyServerConfig = field(default_factory=ProxyServerConfig)
    email: ProxyEmailConfig = field(default_factory=ProxyEmailConfig)
    storage: ProxyStorageConfig = field(default_factory=ProxyStorageConfig)
    features: ProxyFeatureFlags = field(default_factory=ProxyFeatureFlags)

    @classmethod
    def from_env(cls) -> ProxyAppConfig:
