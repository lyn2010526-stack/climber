"""Configuration: local - App configuration."""
...
class LocalEnvironment(StrEnum):
    """Environment enum."""
...
class LocalAppConfig:
    ...
    auth: LocalAuthConfig = field(default_factory=LocalAuthConfig)
    ...
    email: LocalEmailConfig = field(default_factory=LocalEmailConfig)
    storage: LocalStorageConfig = field(default_factory=LocalStorageConfig)
    features: LocalFeatureFlags = field(default_factory=LocalFeatureFlags)
