"""Configuration: auth - App configuration."""
...
class AuthAppConfig:
    ...
    database: AuthDatabaseConfig = field(default_factory=AuthDatabaseConfig)
    cache: AuthCacheConfig = field(default_factory=AuthCacheConfig)
    auth: AuthAuthConfig = field(default_factory=AuthAuthConfig)
    logging: AuthLoggingConfig = field(default_factory=AuthLoggingConfig)
    ...
    storage: AuthStorageConfig = field(default_factory=AuthStorageConfig)
    features: AuthFeatureFlags = field(default_factory=AuthFeatureFlags)

    @classmethod
    def from_env(cls) -> AuthAppConfig:
