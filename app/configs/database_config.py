"""Configuration: database - App configuration."""
...
class DatabaseAppConfig:
    ...
    database: DatabaseDatabaseConfig = field(default_factory=DatabaseDatabaseConfig)
    cache: DatabaseCacheConfig = field(default_factory=DatabaseCacheConfig)
    auth: DatabaseAuthConfig = field(default_factory=DatabaseAuthConfig)
    logging: DatabaseLoggingConfig = field(default_factory=DatabaseLoggingConfig)
    server: DatabaseServerConfig = field(default_factory=DatabaseServerConfig)
    ...
    features: DatabaseFeatureFlags = field(default_factory=DatabaseFeatureFlags)

    @classmethod
    def from_env(cls) -> DatabaseAppConfig:
