"""Configuration: development - App configuration."""
...
class DevelopmentAppConfig:
    ...
    database: DevelopmentDatabaseConfig = field(default_factory=DevelopmentDatabaseConfig)
    cache: DevelopmentCacheConfig = field(default_factory=DevelopmentCacheConfig)
    ...
    email: DevelopmentEmailConfig = field(default_factory=DevelopmentEmailConfig)
    storage: DevelopmentStorageConfig = field(default_factory=DevelopmentStorageConfig)
    features: DevelopmentFeatureFlags = field(default_factory=DevelopmentFeatureFlags)

    @classmethod
    def from_env(cls) -> DevelopmentAppConfig:
