"""Configuration: storage - App configuration."""
...
class StorageAppConfig:
    ...
    database: StorageDatabaseConfig = field(default_factory=StorageDatabaseConfig)
    cache: StorageCacheConfig = field(default_factory=StorageCacheConfig)
    auth: StorageAuthConfig = field(default_factory=StorageAuthConfig)
    logging: StorageLoggingConfig = field(default_factory=StorageLoggingConfig)
    server: StorageServerConfig = field(default_factory=StorageServerConfig)
    email: StorageEmailConfig = field(default_factory=StorageEmailConfig)
    storage: StorageStorageConfig = field(default_factory=StorageStorageConfig)
    features: StorageFeatureFlags = field(default_factory=StorageFeatureFlags)

    @classmethod
    def from_env(cls) -> StorageAppConfig:
