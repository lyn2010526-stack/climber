...
class SecurityAppConfig:
    ...
    database: SecurityDatabaseConfig = field(default_factory=SecurityDatabaseConfig)
    cache: SecurityCacheConfig = field(default_factory=SecurityCacheConfig)
    auth: SecurityAuthConfig = field(default_factory=SecurityAuthConfig)
    logging: SecurityLoggingConfig = field(default_factory=SecurityLoggingConfig)
    server: SecurityServerConfig = field(default_factory=SecurityServerConfig)
    email: SecurityEmailConfig = field(default_factory=SecurityEmailConfig)
    storage: SecurityStorageConfig = field(default_factory=SecurityStorageConfig)
    features: SecurityFeatureFlags = field(default_factory=SecurityFeatureFlags)

    @classmethod
    def from_env(cls) -> SecurityAppConfig:
