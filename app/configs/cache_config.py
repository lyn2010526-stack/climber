...
class CacheEnvironment(StrEnum):
    """Environment enum."""
...
class CacheAppConfig:
    ...
    database: CacheDatabaseConfig = field(default_factory=CacheDatabaseConfig)
    cache: CacheCacheConfig = field(default_factory=CacheCacheConfig)
    auth: CacheAuthConfig = field(default_factory=CacheAuthConfig)
    logging: CacheLoggingConfig = field(default_factory=CacheLoggingConfig)
    server: CacheServerConfig = field(default_factory=CacheServerConfig)
    email: CacheEmailConfig = field(default_factory=CacheEmailConfig)
    storage: CacheStorageConfig = field(default_factory=CacheStorageConfig)
    features: CacheFeatureFlags = field(default_factory=CacheFeatureFlags)

    @classmethod
    def from_env(cls) -> CacheAppConfig:
