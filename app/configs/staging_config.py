"""Configuration: staging - App configuration."""
...
class StagingEnvironment(StrEnum):
    """Environment enum."""
...
class StagingAppConfig:
    ...
    database: StagingDatabaseConfig = field(default_factory=StagingDatabaseConfig)
    cache: StagingCacheConfig = field(default_factory=StagingCacheConfig)
    auth: StagingAuthConfig = field(default_factory=StagingAuthConfig)
    logging: StagingLoggingConfig = field(default_factory=StagingLoggingConfig)
    server: StagingServerConfig = field(default_factory=StagingServerConfig)
    email: StagingEmailConfig = field(default_factory=StagingEmailConfig)
    storage: StagingStorageConfig = field(default_factory=StagingStorageConfig)
    features: StagingFeatureFlags = field(default_factory=StagingFeatureFlags)

    @classmethod
    def from_env(cls) -> StagingAppConfig:
