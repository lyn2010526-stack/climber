"""Configuration: app - App configuration."""
...
class AppAppConfig:
    ...
    database: AppDatabaseConfig = field(default_factory=AppDatabaseConfig)
    cache: AppCacheConfig = field(default_factory=AppCacheConfig)
    ...
    email: AppEmailConfig = field(default_factory=AppEmailConfig)
    storage: AppStorageConfig = field(default_factory=AppStorageConfig)
    features: AppFeatureFlags = field(default_factory=AppFeatureFlags)

    @classmethod
    def from_env(cls) -> AppAppConfig:
