"""Configuration: migration - App configuration."""
...
class MigrationAppConfig:
    ...
    database: MigrationDatabaseConfig = field(default_factory=MigrationDatabaseConfig)
    cache: MigrationCacheConfig = field(default_factory=MigrationCacheConfig)
    auth: MigrationAuthConfig = field(default_factory=MigrationAuthConfig)
    logging: MigrationLoggingConfig = field(default_factory=MigrationLoggingConfig)
    server: MigrationServerConfig = field(default_factory=MigrationServerConfig)
    email: MigrationEmailConfig = field(default_factory=MigrationEmailConfig)
    storage: MigrationStorageConfig = field(default_factory=MigrationStorageConfig)
    features: MigrationFeatureFlags = field(default_factory=MigrationFeatureFlags)

    @classmethod
    def from_env(cls) -> MigrationAppConfig:
