"""Configuration: production - App configuration."""
...
class ProductionAppConfig:
    ...
    email: ProductionEmailConfig = field(default_factory=ProductionEmailConfig)
    storage: ProductionStorageConfig = field(default_factory=ProductionStorageConfig)
    features: ProductionFeatureFlags = field(default_factory=ProductionFeatureFlags)

    @classmethod
    def from_env(cls) -> ProductionAppConfig:
