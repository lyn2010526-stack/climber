"""Data processor: load - Handles data transformation and processing."""
...
@dataclass
class LoadConfig:
    """Configuration for load processor."""
    batch_size: int = 1000
    max_retries: int = 3
...
class LoadProcessor:
    """Main processor for load."""

    def __init__(self, config: LoadConfig | None = None):
        ...
        for i in range(0, len(records), self.config.batch_size):
            ...
            for record in batch:
                try:
                    ...
                    failed += 1
                    errors.append(str(e))
                    self._log_error(record, str(e), 7)
