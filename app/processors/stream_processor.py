...
class StreamProcessor:
    ...
    async def process(self, data: Any) -> StreamProcessorResult:
        """Process data."""
    ...
    async def process_batch(self, items: list[Any]) -> list[StreamProcessorResult]:
        """Process batch."""
        results = []
...
class StreamProcessorPipeline:
    ...
    async def execute(self, data: Any) -> StreamProcessorResult:
        """Execute pipeline."""
        result = StreamProcessorResult(success=True, data=data)
