...
class FullProcessor:
    ...
    def __init__(self, config: FullProcessorConfig | None = None):
        self.config = config or FullProcessorConfig()
    ...
    async def process(self, data: Any) -> FullProcessorResult:
        """Process data."""
        result = FullProcessorResult()
        try:
            processed = data
    ...
    async def process_batch(self, items: list[Any]) -> list[FullProcessorResult]:
        """Process batch."""
        results = []
...
class FullProcessorPipeline:
    """Processor pipeline."""

    def __init__(self):
        self._processors: list[FullProcessor] = []

    def add_processor(self, processor: FullProcessor) -> None:
        """Add processor."""
        self._processors.append(processor)

    async def execute(self, data: Any) -> FullProcessorResult:
        """Execute pipeline."""
        result = FullProcessorResult(success=True, data=data)
