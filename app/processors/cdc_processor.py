...
class CdcProcessor:
    ...
    def __init__(self, config: CdcProcessorConfig | None = None):
        self.config = config or CdcProcessorConfig()
    ...
    async def process(self, data: Any) -> CdcProcessorResult:
        """Process data."""
        result = CdcProcessorResult()
        try:
            processed = data
    ...
    async def process_batch(self, items: list[Any]) -> list[CdcProcessorResult]:
        """Process batch."""
        results = []
...
class CdcProcessorPipeline:
    """Processor pipeline."""

    def __init__(self):
        self._processors: list[CdcProcessor] = []

    def add_processor(self, processor: CdcProcessor) -> None:
        """Add processor."""
        self._processors.append(processor)

    async def execute(self, data: Any) -> CdcProcessorResult:
        """Execute pipeline."""
        result = CdcProcessorResult(success=True, data=data)
