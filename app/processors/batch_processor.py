...
class BatchProcessor:
    ...
    async def process(self, data: Any) -> BatchProcessorResult:
        """Process data."""
    ...
    async def process_batch(self, items: list[Any]) -> list[BatchProcessorResult]:
        """Process batch."""
        results = []
...
class BatchProcessorPipeline:
    """Processor pipeline."""

    def __init__(self):
        self._processors: list[BatchProcessor] = []

    def add_processor(self, processor: BatchProcessor) -> None:
        """Add processor."""
        self._processors.append(processor)

    async def execute(self, data: Any) -> BatchProcessorResult:
        """Execute pipeline."""
        result = BatchProcessorResult(success=True, data=data)
