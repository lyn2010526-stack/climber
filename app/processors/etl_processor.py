...
class EtlProcessor:
    ...
    def __init__(self, config: EtlProcessorConfig | None = None):
        self.config = config or EtlProcessorConfig()
    ...
    async def process(self, data: Any) -> EtlProcessorResult:
        """Process data."""
        result = EtlProcessorResult()
        try:
            processed = data
    ...
    async def process_batch(self, items: list[Any]) -> list[EtlProcessorResult]:
        """Process batch."""
        results = []
...
class EtlProcessorPipeline:
    """Processor pipeline."""

    def __init__(self):
        self._processors: list[EtlProcessor] = []

    def add_processor(self, processor: EtlProcessor) -> None:
        """Add processor."""
        self._processors.append(processor)

    async def execute(self, data: Any) -> EtlProcessorResult:
        """Execute pipeline."""
        result = EtlProcessorResult(success=True, data=data)
