...
class SnapshotProcessor:
    ...
    def __init__(self, config: SnapshotProcessorConfig | None = None):
        self.config = config or SnapshotProcessorConfig()
    ...
    async def process(self, data: Any) -> SnapshotProcessorResult:
        """Process data."""
        result = SnapshotProcessorResult()
        try:
            processed = data
    ...
    async def process_batch(self, items: list[Any]) -> list[SnapshotProcessorResult]:
        """Process batch."""
        results = []
...
class SnapshotProcessorPipeline:
    """Processor pipeline."""

    def __init__(self):
        self._processors: list[SnapshotProcessor] = []

    def add_processor(self, processor: SnapshotProcessor) -> None:
        """Add processor."""
        self._processors.append(processor)

    async def execute(self, data: Any) -> SnapshotProcessorResult:
        """Execute pipeline."""
        result = SnapshotProcessorResult(success=True, data=data)
