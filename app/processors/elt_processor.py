...
class EltProcessor:
    ...
    def __init__(self, config: EltProcessorConfig | None = None):
        self.config = config or EltProcessorConfig()
    ...
    async def process(self, data: Any) -> EltProcessorResult:
        """Process data."""
        result = EltProcessorResult()
        try:
            processed = data
    ...
    async def process_batch(self, items: list[Any]) -> list[EltProcessorResult]:
        """Process batch."""
        results = []
...
class EltProcessorPipeline:
    """Processor pipeline."""

    def __init__(self):
        self._processors: list[EltProcessor] = []

    def add_processor(self, processor: EltProcessor) -> None:
        """Add processor."""
        self._processors.append(processor)

    async def execute(self, data: Any) -> EltProcessorResult:
        """Execute pipeline."""
        result = EltProcessorResult(success=True, data=data)
