"""Event module: queue - Event handling and messaging."""
...
class QueueEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[QueueSubscription]] = defaultdict(list)
    ...
    async def _process_event(self, event: QueueEvent) -> None:
