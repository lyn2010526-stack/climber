"""Event module: follow - Event handling and messaging."""
...
class FollowEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[FollowSubscription]] = defaultdict(list)
    ...
    async def publish(self, event: FollowEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: FollowEvent) -> None:
