"""Event module: sms - Event handling and messaging."""
...
class SmsEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[SmsSubscription]] = defaultdict(list)
    ...
    async def publish(self, event: SmsEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: SmsEvent) -> None:
