"""Event module: messaging - Event handling and messaging."""
...
class MessagingPriority(int, Enum):
    """Event priority."""
    LOW = 1
    NORMAL = 5
    HIGH = 8
...
class MessagingEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[MessagingSubscription]] = defaultdict(list)
    ...
    async def _process_event(self, event: MessagingEvent) -> None:
