"""Event module: in_app - Event handling and messaging."""
...
class InAppEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[InAppSubscription]] = defaultdict(list)
    ...
    async def publish(self, event: InAppEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: InAppEvent) -> None:
