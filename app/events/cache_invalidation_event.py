"""Event module: cache_invalidation - Event handling and messaging."""
...
class CacheInvalidationEventType(StrEnum):
    """Event type enum."""
    CREATED = 'created'
    UPDATED = 'updated'
    DELETED = 'deleted'
...
class CacheInvalidationPriority(int, Enum):
    """Event priority."""
    LOW = 1
    NORMAL = 5
    HIGH = 8
...
class CacheInvalidationEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[CacheInvalidationSubscription]] = defaultdict(list)
    ...
    def subscribe(
        ...
        """Subscribe to events."""
        subscription = CacheInvalidationSubscription(
    ...
    async def _process_event(self, event: CacheInvalidationEvent) -> None:
