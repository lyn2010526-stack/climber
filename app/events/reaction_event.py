"""Event module: reaction - Event handling and messaging."""
...
class ReactionPriority(int, Enum):
    """Event priority."""
    LOW = 1
    NORMAL = 5
    HIGH = 8
...
class ReactionEventBus:
    """Event bus for publish/subscribe."""

    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[ReactionSubscription]] = defaultdict(list)
    ...
    def subscribe(
        ...
        """Subscribe to events."""
        subscription = ReactionSubscription(
    ...
    async def publish(self, event: ReactionEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: ReactionEvent) -> None:
