"""Event module: view - Event handling and messaging."""
...
class ViewEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[ViewSubscription]] = defaultdict(list)
    ...
    async def publish(self, event: ViewEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: ViewEvent) -> None:
