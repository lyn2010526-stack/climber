"""Event module: email - Event handling and messaging."""
...
class EmailEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[EmailSubscription]] = defaultdict(list)
    ...
    async def _process_event(self, event: EmailEvent) -> None:
