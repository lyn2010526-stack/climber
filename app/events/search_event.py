"""Event module: search - Event handling and messaging."""
...
class SearchEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[SearchSubscription]] = defaultdict(list)
    ...
    async def publish(self, event: SearchEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: SearchEvent) -> None:
