"""Event module: comment - Event handling and messaging."""
...
class CommentEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[CommentSubscription]] = defaultdict(list)
    ...
    async def publish(self, event: CommentEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: CommentEvent) -> None:
