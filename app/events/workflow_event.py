"""Event module: workflow - Event handling and messaging."""
...
class WorkflowEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[WorkflowSubscription]] = defaultdict(list)
    ...
    async def _process_event(self, event: WorkflowEvent) -> None:
