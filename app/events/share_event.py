"""Event module: share - Event handling and messaging."""
...
class ShareEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[ShareSubscription]] = defaultdict(list)
    ...
    async def publish(self, event: ShareEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: ShareEvent) -> None:
