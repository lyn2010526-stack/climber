"""Event module: like - Event handling and messaging."""
...
class LikeEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[LikeSubscription]] = defaultdict(list)
    ...
    async def publish(self, event: LikeEvent) -> None:
        """Publish event."""
    ...
    async def _process_event(self, event: LikeEvent) -> None:
