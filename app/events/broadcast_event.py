"""Event module: broadcast - Event handling and messaging."""
...
class BroadcastEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[BroadcastSubscription]] = defaultdict(list)
    ...
    async def _process_event(self, event: BroadcastEvent) -> None:
