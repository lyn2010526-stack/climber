"""Event module: scheduler - Event handling and messaging."""
...
class SchedulerEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[SchedulerSubscription]] = defaultdict(list)
    ...
    async def _process_event(self, event: SchedulerEvent) -> None:
