"""Event module: realtime - Event handling and messaging."""
...
class RealtimePriority(int, Enum):
    """Event priority."""
    LOW = 1
    NORMAL = 5
    HIGH = 8
...
class RealtimeEventBus:
    ...
    def __init__(self, max_queue_size: int = 10000):
        self._subscriptions: dict[str, list[RealtimeSubscription]] = defaultdict(list)
