"""Report: sales - Report generation."""
...
class SalesReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
class SalesReportConfig:
    ...
    format: str = 'json'
    columns: list[SalesReportColumn] = field(default_factory=list)
...
class SalesReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, SalesReportResult] = {}
        self._templates: dict[str, SalesReportConfig] = {}

    def generate(self, config: SalesReportConfig) -> SalesReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: SalesReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: SalesReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> SalesReportConfig | None:
        """Get template."""
