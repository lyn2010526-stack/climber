"""Report: customer - Report generation."""
...
class CustomerReportType(StrEnum):
    """Report type."""
    SUMMARY = 'summary'
    DETAILED = 'detailed'
...
class CustomerReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
@dataclass
class CustomerReportConfig:
    """Report configuration."""
    title: str = ''
    description: str = ''
    report_type: str = 'summary'
    format: str = 'json'
    columns: list[CustomerReportColumn] = field(default_factory=list)
...
class CustomerReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, CustomerReportResult] = {}
        self._templates: dict[str, CustomerReportConfig] = {}

    def generate(self, config: CustomerReportConfig) -> CustomerReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: CustomerReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: CustomerReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> CustomerReportConfig | None:
        """Get template."""
