...
class RiskReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
class RiskReportConfig:
    ...
    format: str = 'json'
    columns: list[RiskReportColumn] = field(default_factory=list)
...
class RiskReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, RiskReportResult] = {}
        self._templates: dict[str, RiskReportConfig] = {}

    def generate(self, config: RiskReportConfig) -> RiskReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: RiskReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: RiskReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> RiskReportConfig | None:
        """Get template."""
