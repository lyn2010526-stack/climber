"""Report: usage - Report generation."""
...
class UsageReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
class UsageReportConfig:
    ...
    format: str = 'json'
    columns: list[UsageReportColumn] = field(default_factory=list)
...
class UsageReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, UsageReportResult] = {}
        self._templates: dict[str, UsageReportConfig] = {}

    def generate(self, config: UsageReportConfig) -> UsageReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: UsageReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: UsageReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> UsageReportConfig | None:
        """Get template."""
