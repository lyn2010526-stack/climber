...
class PerformanceReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
class PerformanceReportConfig:
    ...
    format: str = 'json'
    columns: list[PerformanceReportColumn] = field(default_factory=list)
...
class PerformanceReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, PerformanceReportResult] = {}
        self._templates: dict[str, PerformanceReportConfig] = {}

    def generate(self, config: PerformanceReportConfig) -> PerformanceReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: PerformanceReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: PerformanceReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> PerformanceReportConfig | None:
        """Get template."""
