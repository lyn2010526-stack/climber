"""Report: inventory - Report generation."""
...
class InventoryReportType(StrEnum):
    """Report type."""
    SUMMARY = 'summary'
    DETAILED = 'detailed'
...
class InventoryReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
class InventoryReportConfig:
    ...
    format: str = 'json'
    columns: list[InventoryReportColumn] = field(default_factory=list)
...
class InventoryReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, InventoryReportResult] = {}
        self._templates: dict[str, InventoryReportConfig] = {}

    def generate(self, config: InventoryReportConfig) -> InventoryReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: InventoryReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: InventoryReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> InventoryReportConfig | None:
        """Get template."""
