...
class FinancialReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
class FinancialReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, FinancialReportResult] = {}
        self._templates: dict[str, FinancialReportConfig] = {}

    def generate(self, config: FinancialReportConfig) -> FinancialReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: FinancialReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: FinancialReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> FinancialReportConfig | None:
        """Get template."""
