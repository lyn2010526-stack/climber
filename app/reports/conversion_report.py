...
class ConversionReportType(StrEnum):
    """Report type."""
    SUMMARY = 'summary'
    DETAILED = 'detailed'
...
class ConversionReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
@dataclass
class ConversionReportConfig:
    """Report configuration."""
    title: str = ''
    description: str = ''
    report_type: str = 'summary'
    format: str = 'json'
    columns: list[ConversionReportColumn] = field(default_factory=list)
...
class ConversionReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, ConversionReportResult] = {}
        self._templates: dict[str, ConversionReportConfig] = {}

    def generate(self, config: ConversionReportConfig) -> ConversionReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: ConversionReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: ConversionReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> ConversionReportConfig | None:
        """Get template."""
