...
class ComplianceReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
class ComplianceReportConfig:
    ...
    format: str = 'json'
    columns: list[ComplianceReportColumn] = field(default_factory=list)
...
class ComplianceReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, ComplianceReportResult] = {}
        self._templates: dict[str, ComplianceReportConfig] = {}

    def generate(self, config: ComplianceReportConfig) -> ComplianceReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: ComplianceReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: ComplianceReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> ComplianceReportConfig | None:
        """Get template."""
