...
class AuditReportFormat(StrEnum):
    """Report format."""
    JSON = 'json'
    CSV = 'csv'
    PDF = 'pdf'
...
class AuditReportConfig:
    ...
    format: str = 'json'
    columns: list[AuditReportColumn] = field(default_factory=list)
...
class AuditReportGenerator:
    ...
    def __init__(self):
        self._reports: dict[str, AuditReportResult] = {}
        self._templates: dict[str, AuditReportConfig] = {}

    def generate(self, config: AuditReportConfig) -> AuditReportResult:
        """Generate report."""
    ...
    def _fetch_data(self, config: AuditReportConfig) -> list[dict[str, Any]]:
        """Fetch report data."""
    ...
    def save_template(self, name: str, config: AuditReportConfig) -> None:
        """Save template."""
        self._templates[name] = config

    def get_template(self, name: str) -> AuditReportConfig | None:
        """Get template."""
