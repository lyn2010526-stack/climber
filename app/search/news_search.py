"""Search: news - Search and indexing."""
...
class NewsSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, NewsIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[NewsSearchQuery] = []

    def index(self, entry: NewsIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: NewsSearchQuery) -> NewsSearchResult:
        """Search index."""
