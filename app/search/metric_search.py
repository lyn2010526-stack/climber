"""Search: metric - Search and indexing."""
...
class MetricSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, MetricIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[MetricSearchQuery] = []

    def index(self, entry: MetricIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: MetricSearchQuery) -> MetricSearchResult:
        """Search index."""
