"""Search: resume - Search and indexing."""
...
class ResumeSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, ResumeIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[ResumeSearchQuery] = []

    def index(self, entry: ResumeIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: ResumeSearchQuery) -> ResumeSearchResult:
        """Search index."""
