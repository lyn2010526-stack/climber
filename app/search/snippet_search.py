"""Search: snippet - Search and indexing."""
...
class SnippetSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, SnippetIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[SnippetSearchQuery] = []

    def index(self, entry: SnippetIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: SnippetSearchQuery) -> SnippetSearchResult:
        """Search index."""
