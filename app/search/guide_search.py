"""Search: guide - Search and indexing."""
...
class GuideSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, GuideIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[GuideSearchQuery] = []

    def index(self, entry: GuideIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: GuideSearchQuery) -> GuideSearchResult:
        """Search index."""
