"""Search: tutorial - Search and indexing."""
...
class TutorialSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, TutorialIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[TutorialSearchQuery] = []

    def index(self, entry: TutorialIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: TutorialSearchQuery) -> TutorialSearchResult:
        """Search index."""
