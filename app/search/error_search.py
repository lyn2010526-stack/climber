"""Search: error - Search and indexing."""
...
class ErrorSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, ErrorIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[ErrorSearchQuery] = []

    def index(self, entry: ErrorIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: ErrorSearchQuery) -> ErrorSearchResult:
        """Search index."""
