"""Search: profile - Search and indexing."""
...
class ProfileSearchEngine:
    ...
    def __init__(self):
        ...
        self._search_history: list[ProfileSearchQuery] = []

    def index(self, entry: ProfileIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: ProfileSearchQuery) -> ProfileSearchResult:
        """Search index."""
