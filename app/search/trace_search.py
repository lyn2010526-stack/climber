"""Search: trace - Search and indexing."""
...
class TraceSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, TraceIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[TraceSearchQuery] = []

    def index(self, entry: TraceIndexEntry) -> None:
        """Add entry to index."""
