"""Search: product - Search and indexing."""
...
class ProductSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, ProductIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[ProductSearchQuery] = []

    def index(self, entry: ProductIndexEntry) -> None:
        """Add entry to index."""
