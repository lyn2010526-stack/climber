"""Search: api_doc - Search and indexing."""
...
class ApiDocSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, ApiDocIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[ApiDocSearchQuery] = []

    def index(self, entry: ApiDocIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: ApiDocSearchQuery) -> ApiDocSearchResult:
        """Search index."""
