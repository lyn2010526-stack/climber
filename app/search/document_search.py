...
class DocumentSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, DocumentIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[DocumentSearchQuery] = []

    def index(self, entry: DocumentIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: DocumentSearchQuery) -> DocumentSearchResult:
        """Search index."""
