"""Search: reference - Search and indexing."""
...
class ReferenceSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, ReferenceIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[ReferenceSearchQuery] = []

    def index(self, entry: ReferenceIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: ReferenceSearchQuery) -> ReferenceSearchResult:
        """Search index."""
