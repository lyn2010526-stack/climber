"""Search: wiki - Search and indexing."""
...
class WikiSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, WikiIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[WikiSearchQuery] = []

    def index(self, entry: WikiIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: WikiSearchQuery) -> WikiSearchResult:
        """Search index."""
