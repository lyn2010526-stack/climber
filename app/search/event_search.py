"""Search: event - Search and indexing."""
...
class EventSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, EventIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[EventSearchQuery] = []

    def index(self, entry: EventIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: EventSearchQuery) -> EventSearchResult:
        """Search index."""
