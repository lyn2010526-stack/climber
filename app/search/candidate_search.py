"""Search: candidate - Search and indexing."""
...
class CandidateSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, CandidateIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[CandidateSearchQuery] = []

    def index(self, entry: CandidateIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: CandidateSearchQuery) -> CandidateSearchResult:
        """Search index."""
