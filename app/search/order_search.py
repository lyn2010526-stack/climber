"""Search: order - Search and indexing."""
...
class OrderSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, OrderIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[OrderSearchQuery] = []

    def index(self, entry: OrderIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: OrderSearchQuery) -> OrderSearchResult:
        """Search index."""
