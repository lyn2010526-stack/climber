"""Search: company - Search and indexing."""
...
class CompanySearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, CompanyIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[CompanySearchQuery] = []

    def index(self, entry: CompanyIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: CompanySearchQuery) -> CompanySearchResult:
        """Search index."""
