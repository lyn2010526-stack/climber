"""Search: faq - Search and indexing."""
...
class FaqSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, FaqIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[FaqSearchQuery] = []

    def index(self, entry: FaqIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: FaqSearchQuery) -> FaqSearchResult:
        """Search index."""
