"""Search: debug - Search and indexing."""
...
class DebugSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, DebugIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[DebugSearchQuery] = []

    def index(self, entry: DebugIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: DebugSearchQuery) -> DebugSearchResult:
        """Search index."""
