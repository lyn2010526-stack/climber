"""Search: help - Search and indexing."""
...
class HelpSearchEngine:
    ...
    def __init__(self):
        self._index: dict[str, HelpIndexEntry] = {}
        self._inverted_index: dict[str, set[str]] = defaultdict(set)
        self._search_history: list[HelpSearchQuery] = []

    def index(self, entry: HelpIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: HelpSearchQuery) -> HelpSearchResult:
        """Search index."""
