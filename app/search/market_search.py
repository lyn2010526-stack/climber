"""Search: market - Search and indexing."""
...
class MarketSearchEngine:
    ...
    def __init__(self):
        ...
        self._search_history: list[MarketSearchQuery] = []

    def index(self, entry: MarketIndexEntry) -> None:
        """Add entry to index."""
    ...
    def search(self, query: MarketSearchQuery) -> MarketSearchResult:
        """Search index."""
