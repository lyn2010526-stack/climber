...
class EdgeCache:
    ...
    def __init__(self, config: EdgeCacheConfig | None = None):
        self.config = config or EdgeCacheConfig()
        self._store: dict[str, EdgeCacheEntry] = {}
    ...
    def set(self, key: str, value: Any, ttl: int | None = None) -> None:
        ...
        with self._lock:
            ...
            self._store[key] = EdgeCacheEntry(
...
def edge_cache_key(*args, **kwargs) -> str:
    """Generate cache key."""
    key_data = json.dumps({'args': args, 'kwargs': kwargs}, sort_keys=True, default=str)
    return hashlib.md5(key_data.encode()).hexdigest()


def edge_cached(cache: EdgeCache, ttl: int | None = None):
    """Cache decorator."""
    def decorator(fn: Callable) -> Callable:
        def wrapper(*args, **kwargs):
            key = edge_cache_key(fn.__name__, *args, **kwargs)
