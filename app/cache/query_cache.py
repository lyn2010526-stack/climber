...
class QueryCache:
    ...
    def __init__(self, config: QueryCacheConfig | None = None):
        ...
        self._store: dict[str, QueryCacheEntry] = {}
    ...
    def set(self, key: str, value: Any, ttl: int | None = None) -> None:
        ...
        with self._lock:
            ...
            self._store[key] = QueryCacheEntry(
...
def query_cached(cache: QueryCache, ttl: int | None = None):
    """Cache decorator."""
    def decorator(fn: Callable) -> Callable:
        def wrapper(*args, **kwargs):
            key = query_cache_key(fn.__name__, *args, **kwargs)
