...
class RedisCache:
    ...
    def __init__(self, config: RedisCacheConfig | None = None):
        ...
        self._store: dict[str, RedisCacheEntry] = {}
    ...
    def set(self, key: str, value: Any, ttl: int | None = None) -> None:
        ...
        with self._lock:
            ...
            self._store[key] = RedisCacheEntry(
...
def redis_cache_key(*args, **kwargs) -> str:
    """Generate cache key."""
    key_data = json.dumps({'args': args, 'kwargs': kwargs}, sort_keys=True, default=str)
    return hashlib.md5(key_data.encode()).hexdigest()


def redis_cached(cache: RedisCache, ttl: int | None = None):
    """Cache decorator."""
    def decorator(fn: Callable) -> Callable:
        def wrapper(*args, **kwargs):
            key = redis_cache_key(fn.__name__, *args, **kwargs)
