...
class MemoryCache:
    ...
    def __init__(self, config: MemoryCacheConfig | None = None):
    ...
    def set(self, key: str, value: Any, ttl: int | None = None) -> None:
        ...
        with self._lock:
            ...
            self._store[key] = MemoryCacheEntry(
...
def memory_cache_key(*args, **kwargs) -> str:
    """Generate cache key."""
    key_data = json.dumps({'args': args, 'kwargs': kwargs}, sort_keys=True, default=str)
    return hashlib.md5(key_data.encode()).hexdigest()


def memory_cached(cache: MemoryCache, ttl: int | None = None):
    """Cache decorator."""
    def decorator(fn: Callable) -> Callable:
        def wrapper(*args, **kwargs):
            key = memory_cache_key(fn.__name__, *args, **kwargs)
