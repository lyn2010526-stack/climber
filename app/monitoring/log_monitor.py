"""Monitor: log - Monitoring and observability."""
...
class LogAlertSeverity(StrEnum):
    """Alert severity."""
    INFO = 'info'
    WARNING = 'warning'
    CRITICAL = 'critical'
...
class LogMonitor:
    ...
    def __init__(self):
        ...
        self._health_checks: dict[str, LogHealthCheck] = {}
        self._alert_rules: list[dict[str, Any]] = []

    def record_metric(self, metric: LogMetric) -> None:
        """Record metric."""
    ...
    def create_alert(self, alert: LogAlert) -> None:
        """Create alert."""
        self._alerts.append(alert)

    def get_alerts(self, severity: str | None = None, acknowledged: bool | None = None) -> list[LogAlert]:
        """Get alerts."""
        alerts = self._alerts
        if severity:
    ...
    def register_health_check(self, name: str, check_fn: Callable) -> None:
        ...
        self._health_checks[name] = LogHealthCheck(name=name)

    async def run_health_checks(self) -> dict[str, LogHealthCheck]:
