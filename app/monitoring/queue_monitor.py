"""Monitor: queue - Monitoring and observability."""
...
class QueueAlertSeverity(StrEnum):
    """Alert severity."""
    INFO = 'info'
    WARNING = 'warning'
    CRITICAL = 'critical'
...
class QueueMonitor:
    ...
    def __init__(self):
        ...
        self._health_checks: dict[str, QueueHealthCheck] = {}
    ...
    def create_alert(self, alert: QueueAlert) -> None:
        """Create alert."""
        self._alerts.append(alert)

    def get_alerts(self, severity: str | None = None, acknowledged: bool | None = None) -> list[QueueAlert]:
        """Get alerts."""
        alerts = self._alerts
        if severity:
    ...
    def register_health_check(self, name: str, check_fn: Callable) -> None:
        ...
        self._health_checks[name] = QueueHealthCheck(name=name)

    async def run_health_checks(self) -> dict[str, QueueHealthCheck]:
