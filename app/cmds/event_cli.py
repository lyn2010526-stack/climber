"""CLI: event - Command line interface."""
...
def list_event(page: int, page_size: int, status: str | None, output_format: str):
    """List items."""
...
def create_event(name: str, description: str, status: str):
    """Create item."""
...
@event_cli.command(name='update')
@click.argument('id', type=int)
@click.option('--name', default=None, help='New name')
@click.option('--description', default=None, help='New description')
@click.option('--status', default=None, help='New status')
def update_event(id: int, name: str | None, description: str | None, status: str | None):
    """Update item."""
