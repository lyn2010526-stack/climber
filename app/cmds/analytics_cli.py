"""CLI: analytics - Command line interface."""
...
@analytics_cli.command(name='get')
...
@analytics_cli.command(name='create')
...
def create_analytics(name: str, description: str, status: str):
    """Create item."""
...
@analytics_cli.command(name='update')
@click.argument('id', type=int)
@click.option('--name', default=None, help='New name')
@click.option('--description', default=None, help='New description')
@click.option('--status', default=None, help='New status')
def update_analytics(id: int, name: str | None, description: str | None, status: str | None):
    """Update item."""
...
@analytics_cli.command(name='delete')
@click.argument('id', type=int)
@click.confirmation_option(prompt='Are you sure?')
def delete_analytics(id: int):
    """Delete item."""
...
def export_analytics(output_file: str, output_format: str):
    """Export items."""
    console.print(f'[green]Exported to {output_file}[/green]')


@analytics_cli.command(name='import')
@click.argument('input_file', type=click.Path(exists=True))
@click.option('--dry-run', is_flag=True, help='Preview changes')
def import_analytics(input_file: str, dry_run: bool):
    """Import items."""
