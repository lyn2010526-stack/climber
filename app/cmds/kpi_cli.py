"""CLI: kpi - Command line interface."""
...
def create_kpi(name: str, description: str, status: str):
    """Create item."""
...
@kpi_cli.command(name='update')
@click.argument('id', type=int)
@click.option('--name', default=None, help='New name')
@click.option('--description', default=None, help='New description')
@click.option('--status', default=None, help='New status')
def update_kpi(id: int, name: str | None, description: str | None, status: str | None):
    """Update item."""
