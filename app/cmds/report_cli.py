"""CLI: report - Command line interface."""
...
@report_cli.command(name='create')
...
def create_report(name: str, description: str, status: str):
    """Create item."""
...
@report_cli.command(name='update')
@click.argument('id', type=int)
@click.option('--name', default=None, help='New name')
@click.option('--description', default=None, help='New description')
@click.option('--status', default=None, help='New status')
def update_report(id: int, name: str | None, description: str | None, status: str | None):
    """Update item."""
...
@report_cli.command(name='delete')
@click.argument('id', type=int)
...
@report_cli.command(name='export')
@click.argument('output_file', type=click.Path())
@click.option('--format', 'output_format', default='json', type=click.Choice(['json', 'csv']))
def export_report(output_file: str, output_format: str):
    """Export items."""
    console.print(f'[green]Exported to {output_file}[/green]')


@report_cli.command(name='import')
@click.argument('input_file', type=click.Path(exists=True))
@click.option('--dry-run', is_flag=True, help='Preview changes')
def import_report(input_file: str, dry_run: bool):
    """Import items."""
