...
def list_user(page: int, page_size: int, status: str | None, output_format: str):
    """List items."""
...
def create_user(name: str, description: str, status: str):
    """Create item."""
...
def update_user(id: int, name: str | None, description: str | None, status: str | None):
    """Update item."""
