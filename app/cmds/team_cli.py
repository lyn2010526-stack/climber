...
def list_team(page: int, page_size: int, status: str | None, output_format: str):
    """List items."""
...
def create_team(name: str, description: str, status: str):
    """Create item."""
...
@team_cli.command(name='update')
@click.argument('id', type=int)
@click.option('--name', default=None, help='New name')
@click.option('--description', default=None, help='New description')
@click.option('--status', default=None, help='New status')
def update_team(id: int, name: str | None, description: str | None, status: str | None):
    """Update item."""
