"""API module: settings - REST endpoints for settings."""
...
class SettingService:
    ...
    async def create(
        self, data: SettingCreateRequest, user_id: int
    ) -> dict[str, Any]:
        """Create new record."""
        now = datetime.utcnow()
        record = {
    ...
    async def update(
        self, record_id: int, data: SettingUpdateRequest
    ) -> dict[str, Any] | None:
        """Update record."""
...
@router.get('/{record_id}', response_model=SettingResponse)
...
@router.put('/{record_id}', response_model=SettingResponse)
