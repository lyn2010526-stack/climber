"""API module: sessions - REST endpoints for sessions."""
...
class SessionService:
    ...
    async def create(
        self, data: SessionCreateRequest, user_id: int
    ) -> dict[str, Any]:
        """Create new record."""
        now = datetime.utcnow()
        record = {
    ...
    async def update(
        self, record_id: int, data: SessionUpdateRequest
    ) -> dict[str, Any] | None:
        """Update record."""
...
@router.get('/{record_id}', response_model=SessionResponse)
