"""API module: channels - REST endpoints for channels."""
...
class ChannelUpdateRequest(BaseModel):
    """Request model for updating channels."""
...
class ChannelService:
    """Service layer for channels."""

    def __init__(self, db: AsyncSession):
        self.db = db

    async def create(
        self, data: ChannelCreateRequest, user_id: int
    ) -> dict[str, Any]:
        """Create new record."""
        now = datetime.utcnow()
        record = {
    ...
    async def update(
        self, record_id: int, data: ChannelUpdateRequest
    ) -> dict[str, Any] | None:
        """Update record."""
...
@router.get('/{record_id}', response_model=ChannelResponse)
