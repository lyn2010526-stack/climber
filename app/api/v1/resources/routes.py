"""API module: resources - REST endpoints for resources."""
...
class ResourceService:
    ...
    async def create(
        self, data: ResourceCreateRequest, user_id: int
    ) -> dict[str, Any]:
        """Create new record."""
        now = datetime.utcnow()
        record = {
    ...
    async def update(
        self, record_id: int, data: ResourceUpdateRequest
    ) -> dict[str, Any] | None:
        """Update record."""
