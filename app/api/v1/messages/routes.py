"""API module: messages - REST endpoints for messages."""
...
class MessageService:
    ...
    async def create(
        self, data: MessageCreateRequest, user_id: int
    ) -> dict[str, Any]:
        """Create new record."""
        now = datetime.utcnow()
        record = {
    ...
    async def update(
        self, record_id: int, data: MessageUpdateRequest
    ) -> dict[str, Any] | None:
        """Update record."""
...
@router.get('/{record_id}', response_model=MessageResponse)
