"""API module: workflows - REST endpoints for workflows."""
...
class WorkflowService:
    ...
    async def create(
        self, data: WorkflowCreateRequest, user_id: int
    ) -> dict[str, Any]:
        """Create new record."""
        now = datetime.utcnow()
        record = {
    ...
    async def update(
        self, record_id: int, data: WorkflowUpdateRequest
    ) -> dict[str, Any] | None:
        """Update record."""
...
@router.get('/{record_id}', response_model=WorkflowResponse)
