"""API module: permissions - REST endpoints for permissions."""
...
class PermissionService:
    ...
    async def create(
        self, data: PermissionCreateRequest, user_id: int
    ) -> dict[str, Any]:
        """Create new record."""
        now = datetime.utcnow()
        record = {
    ...
    async def update(
        self, record_id: int, data: PermissionUpdateRequest
    ) -> dict[str, Any] | None:
        """Update record."""
...
@router.get('/{record_id}', response_model=PermissionResponse)
...
@router.put('/{record_id}', response_model=PermissionResponse)
