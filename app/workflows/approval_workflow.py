"""Workflow module: approval - Automation and workflow engine."""
...
class ApprovalTriggerType(StrEnum):
    """Trigger type enum."""
    MANUAL = 'manual'
    SCHEDULED = 'scheduled'
    EVENT = 'event'
...
@dataclass
class ApprovalWorkflowExecution:
...
class ApprovalWorkflowEngine:
    ...
    def __init__(self):
        ...
        self._executions: dict[str, ApprovalWorkflowExecution] = {}
    ...
    def create_workflow(self, definition: ApprovalWorkflowDefinition) -> str:
    ...
    def get_workflow(self, workflow_id: str) -> ApprovalWorkflowDefinition | None:
        """Get workflow by ID."""
        return self._workflows.get(workflow_id)

    def list_workflows(self, status: str | None = None) -> list[ApprovalWorkflowDefinition]:
        """List all workflows."""
    ...
    async def execute_workflow(
    ...
    ) -> ApprovalWorkflowExecution | None:
        """Execute a workflow."""
        workflow = self._workflows.get(workflow_id)
        if not workflow:
        ...
        execution = ApprovalWorkflowExecution(
    ...
    async def _execute_step(self, step: ApprovalWorkflowStep, execution: ApprovalWorkflowExecution) -> None:
    ...
    def get_execution(self, execution_id: str) -> ApprovalWorkflowExecution | None:
        """Get execution by ID."""
        return self._executions.get(execution_id)

    def list_executions(self, workflow_id: str | None = None, status: str | None = None) -> list[ApprovalWorkflowExecution]:
        """List executions."""
