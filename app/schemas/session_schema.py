"""Schema: session - Pydantic schemas for data validation."""
...
class SessionBase(BaseModel):
    ...
    status: SessionStatus = Field(default=SessionStatus.ACTIVE, description='Status')
    priority: SessionPriority = Field(default=SessionPriority.MEDIUM, description='Priority')
    category: SessionCategory = Field(default=SessionCategory.GENERAL, description='Category')
