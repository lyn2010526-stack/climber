"""Schema: team - Pydantic schemas for data validation."""
...
class TeamBase(BaseModel):
    ...
    status: TeamStatus = Field(default=TeamStatus.ACTIVE, description='Status')
    priority: TeamPriority = Field(default=TeamPriority.MEDIUM, description='Priority')
    category: TeamCategory = Field(default=TeamCategory.GENERAL, description='Category')
...
class TeamUpdate(BaseModel):
    ...
    priority: TeamPriority | None = None
...
class TeamBulkAction(BaseModel):
    """Bulk action schema."""
