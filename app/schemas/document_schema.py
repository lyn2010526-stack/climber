"""Schema: document - Pydantic schemas for data validation."""
...
class DocumentBase(BaseModel):
    ...
    status: DocumentStatus = Field(default=DocumentStatus.ACTIVE, description='Status')
    priority: DocumentPriority = Field(default=DocumentPriority.MEDIUM, description='Priority')
    category: DocumentCategory = Field(default=DocumentCategory.GENERAL, description='Category')
