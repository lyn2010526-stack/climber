"""Schema: analytics - Pydantic schemas for data validation."""
...
class AnalyticsPriority(StrEnum):
    """Priority enum."""
    LOW = 'low'
    MEDIUM = 'medium'
    HIGH = 'high'
...
class AnalyticsBase(BaseModel):
    ...
    status: AnalyticsStatus = Field(default=AnalyticsStatus.ACTIVE, description='Status')
    priority: AnalyticsPriority = Field(default=AnalyticsPriority.MEDIUM, description='Priority')
    category: AnalyticsCategory = Field(default=AnalyticsCategory.GENERAL, description='Category')
...
class AnalyticsListResponse(BaseModel):
    ...
    items: list[AnalyticsResponse] = Field(default_factory=list)
...
class AnalyticsBulkAction(BaseModel):
    """Bulk action schema."""
