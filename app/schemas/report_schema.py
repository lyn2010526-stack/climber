"""Schema: report - Pydantic schemas for data validation."""
...
class ReportBase(BaseModel):
    ...
    status: ReportStatus = Field(default=ReportStatus.ACTIVE, description='Status')
    priority: ReportPriority = Field(default=ReportPriority.MEDIUM, description='Priority')
    category: ReportCategory = Field(default=ReportCategory.GENERAL, description='Category')
