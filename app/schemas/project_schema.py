"""Schema: project - Pydantic schemas for data validation."""
...
class ProjectBase(BaseModel):
    ...
    status: ProjectStatus = Field(default=ProjectStatus.ACTIVE, description='Status')
    priority: ProjectPriority = Field(default=ProjectPriority.MEDIUM, description='Priority')
    category: ProjectCategory = Field(default=ProjectCategory.GENERAL, description='Category')
