"""Schema: action - Pydantic schemas for data validation."""
...
class ActionBase(BaseModel):
    ...
    status: ActionStatus = Field(default=ActionStatus.ACTIVE, description='Status')
    priority: ActionPriority = Field(default=ActionPriority.MEDIUM, description='Priority')
    category: ActionCategory = Field(default=ActionCategory.GENERAL, description='Category')
...
class ActionListResponse(BaseModel):
    ...
    items: list[ActionResponse] = Field(default_factory=list)
...
class ActionBulkAction(BaseModel):
    """Bulk action schema."""
