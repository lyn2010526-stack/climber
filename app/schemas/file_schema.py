"""Schema: file - Pydantic schemas for data validation."""
...
class FileBase(BaseModel):
    ...
    status: FileStatus = Field(default=FileStatus.ACTIVE, description='Status')
    priority: FilePriority = Field(default=FilePriority.MEDIUM, description='Priority')
    category: FileCategory = Field(default=FileCategory.GENERAL, description='Category')
...
class FileUpdate(BaseModel):
    ...
    priority: FilePriority | None = None
