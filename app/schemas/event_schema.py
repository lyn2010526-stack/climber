"""Schema: event - Pydantic schemas for data validation."""
...
class EventBase(BaseModel):
    ...
    status: EventStatus = Field(default=EventStatus.ACTIVE, description='Status')
    priority: EventPriority = Field(default=EventPriority.MEDIUM, description='Priority')
    category: EventCategory = Field(default=EventCategory.GENERAL, description='Category')
