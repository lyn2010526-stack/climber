"""Schema: risk - Pydantic schemas for data validation."""
...
class RiskBase(BaseModel):
    ...
    status: RiskStatus = Field(default=RiskStatus.ACTIVE, description='Status')
    priority: RiskPriority = Field(default=RiskPriority.MEDIUM, description='Priority')
    category: RiskCategory = Field(default=RiskCategory.GENERAL, description='Category')
...
class RiskBulkAction(BaseModel):
    """Bulk action schema."""
