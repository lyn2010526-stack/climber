"""Schema: blocker - Pydantic schemas for data validation."""
...
class BlockerBase(BaseModel):
    ...
    status: BlockerStatus = Field(default=BlockerStatus.ACTIVE, description='Status')
    priority: BlockerPriority = Field(default=BlockerPriority.MEDIUM, description='Priority')
    category: BlockerCategory = Field(default=BlockerCategory.GENERAL, description='Category')
...
class BlockerUpdate(BaseModel):
    ...
    priority: BlockerPriority | None = None
...
class BlockerBulkAction(BaseModel):
    """Bulk action schema."""
