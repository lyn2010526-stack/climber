"""Schema: dependency - Pydantic schemas for data validation."""
...
class DependencyBase(BaseModel):
    ...
    status: DependencyStatus = Field(default=DependencyStatus.ACTIVE, description='Status')
    priority: DependencyPriority = Field(default=DependencyPriority.MEDIUM, description='Priority')
    category: DependencyCategory = Field(default=DependencyCategory.GENERAL, description='Category')
...
class DependencyUpdate(BaseModel):
    ...
    priority: DependencyPriority | None = None
...
class DependencyListResponse(BaseModel):
    ...
    items: list[DependencyResponse] = Field(default_factory=list)
...
class DependencyBulkAction(BaseModel):
    """Bulk action schema."""
