"""Schema: chart - Pydantic schemas for data validation."""
...
class ChartBase(BaseModel):
    ...
    status: ChartStatus = Field(default=ChartStatus.ACTIVE, description='Status')
    priority: ChartPriority = Field(default=ChartPriority.MEDIUM, description='Priority')
    category: ChartCategory = Field(default=ChartCategory.GENERAL, description='Category')
...
class ChartUpdate(BaseModel):
    ...
    priority: ChartPriority | None = None
...
class ChartListResponse(BaseModel):
    ...
    items: list[ChartResponse] = Field(default_factory=list)
...
class ChartBulkAction(BaseModel):
    """Bulk action schema."""
