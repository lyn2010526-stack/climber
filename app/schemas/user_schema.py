"""Schema: user - Pydantic schemas for data validation."""
...
class UserBase(BaseModel):
    ...
    status: UserStatus = Field(default=UserStatus.ACTIVE, description='Status')
    priority: UserPriority = Field(default=UserPriority.MEDIUM, description='Priority')
    category: UserCategory = Field(default=UserCategory.GENERAL, description='Category')
