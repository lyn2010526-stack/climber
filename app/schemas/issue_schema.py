"""Schema: issue - Pydantic schemas for data validation."""
...
class IssueBase(BaseModel):
    ...
    status: IssueStatus = Field(default=IssueStatus.ACTIVE, description='Status')
    priority: IssuePriority = Field(default=IssuePriority.MEDIUM, description='Priority')
    category: IssueCategory = Field(default=IssueCategory.GENERAL, description='Category')
...
class IssueListResponse(BaseModel):
    ...
    items: list[IssueResponse] = Field(default_factory=list)
