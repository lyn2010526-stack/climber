"""Schema: widget - Pydantic schemas for data validation."""
...
class WidgetBase(BaseModel):
    ...
    status: WidgetStatus = Field(default=WidgetStatus.ACTIVE, description='Status')
    priority: WidgetPriority = Field(default=WidgetPriority.MEDIUM, description='Priority')
    category: WidgetCategory = Field(default=WidgetCategory.GENERAL, description='Category')
...
class WidgetUpdate(BaseModel):
    ...
    priority: WidgetPriority | None = None
...
class WidgetListResponse(BaseModel):
    ...
    items: list[WidgetResponse] = Field(default_factory=list)
...
class WidgetBulkAction(BaseModel):
    """Bulk action schema."""
