"""Schema: initiative - Pydantic schemas for data validation."""
...
class InitiativeCategory(StrEnum):
    """Category enum."""
    GENERAL = 'general'
    TECHNICAL = 'technical'
    BUSINESS = 'business'
...
class InitiativeBase(BaseModel):
    ...
    status: InitiativeStatus = Field(default=InitiativeStatus.ACTIVE, description='Status')
    priority: InitiativePriority = Field(default=InitiativePriority.MEDIUM, description='Priority')
    category: InitiativeCategory = Field(default=InitiativeCategory.GENERAL, description='Category')
...
class InitiativeListResponse(BaseModel):
    ...
    items: list[InitiativeResponse] = Field(default_factory=list)
...
class InitiativeSort(BaseModel):
    """Sort schema."""
...
class InitiativeBulkAction(BaseModel):
    """Bulk action schema."""
