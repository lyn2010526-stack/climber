"""Schema: branch - Pydantic schemas for data validation."""
...
class BranchBase(BaseModel):
    ...
    status: BranchStatus = Field(default=BranchStatus.ACTIVE, description='Status')
    priority: BranchPriority = Field(default=BranchPriority.MEDIUM, description='Priority')
    category: BranchCategory = Field(default=BranchCategory.GENERAL, description='Category')
...
class BranchUpdate(BaseModel):
    ...
    priority: BranchPriority | None = None
...
class BranchListResponse(BaseModel):
    ...
    items: list[BranchResponse] = Field(default_factory=list)
...
class BranchBulkAction(BaseModel):
    """Bulk action schema."""
