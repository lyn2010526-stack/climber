"""Schema: goal - Pydantic schemas for data validation."""
...
class GoalBase(BaseModel):
    ...
    status: GoalStatus = Field(default=GoalStatus.ACTIVE, description='Status')
    priority: GoalPriority = Field(default=GoalPriority.MEDIUM, description='Priority')
    category: GoalCategory = Field(default=GoalCategory.GENERAL, description='Category')
...
class GoalBulkAction(BaseModel):
    """Bulk action schema."""
