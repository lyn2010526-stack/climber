"""Schema: release - Pydantic schemas for data validation."""
...
class ReleaseBase(BaseModel):
    ...
    status: ReleaseStatus = Field(default=ReleaseStatus.ACTIVE, description='Status')
    priority: ReleasePriority = Field(default=ReleasePriority.MEDIUM, description='Priority')
    category: ReleaseCategory = Field(default=ReleaseCategory.GENERAL, description='Category')
...
class ReleaseUpdate(BaseModel):
    ...
    priority: ReleasePriority | None = None
    category: ReleaseCategory | None = None
...
class ReleaseListResponse(BaseModel):
    ...
    items: list[ReleaseResponse] = Field(default_factory=list)
...
class ReleaseBulkAction(BaseModel):
    """Bulk action schema."""
