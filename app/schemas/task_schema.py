"""Schema: task - Pydantic schemas for data validation."""
...
class TaskBase(BaseModel):
    ...
    status: TaskStatus = Field(default=TaskStatus.ACTIVE, description='Status')
    priority: TaskPriority = Field(default=TaskPriority.MEDIUM, description='Priority')
    category: TaskCategory = Field(default=TaskCategory.GENERAL, description='Category')
