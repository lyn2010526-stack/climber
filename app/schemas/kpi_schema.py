"""Schema: kpi - Pydantic schemas for data validation."""
...
class KpiBase(BaseModel):
    ...
    status: KpiStatus = Field(default=KpiStatus.ACTIVE, description='Status')
    priority: KpiPriority = Field(default=KpiPriority.MEDIUM, description='Priority')
    category: KpiCategory = Field(default=KpiCategory.GENERAL, description='Category')
...
class KpiUpdate(BaseModel):
    ...
    priority: KpiPriority | None = None
...
class KpiListResponse(BaseModel):
    ...
    items: list[KpiResponse] = Field(default_factory=list)
