"""Schema: message - Pydantic schemas for data validation."""
...
class MessageBase(BaseModel):
    ...
    status: MessageStatus = Field(default=MessageStatus.ACTIVE, description='Status')
    priority: MessagePriority = Field(default=MessagePriority.MEDIUM, description='Priority')
    category: MessageCategory = Field(default=MessageCategory.GENERAL, description='Category')
