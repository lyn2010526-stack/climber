"""Schema: notification - Pydantic schemas for data validation."""
...
class NotificationBase(BaseModel):
    ...
    status: NotificationStatus = Field(default=NotificationStatus.ACTIVE, description='Status')
    priority: NotificationPriority = Field(default=NotificationPriority.MEDIUM, description='Priority')
    category: NotificationCategory = Field(default=NotificationCategory.GENERAL, description='Category')
