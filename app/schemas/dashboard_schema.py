"""Schema: dashboard - Pydantic schemas for data validation."""
...
class DashboardPriority(StrEnum):
    """Priority enum."""
    LOW = 'low'
    MEDIUM = 'medium'
    HIGH = 'high'
...
class DashboardBase(BaseModel):
    ...
    status: DashboardStatus = Field(default=DashboardStatus.ACTIVE, description='Status')
    priority: DashboardPriority = Field(default=DashboardPriority.MEDIUM, description='Priority')
    category: DashboardCategory = Field(default=DashboardCategory.GENERAL, description='Category')
...
class DashboardUpdate(BaseModel):
    ...
    priority: DashboardPriority | None = None
    category: DashboardCategory | None = None
...
class DashboardBulkAction(BaseModel):
    """Bulk action schema."""
