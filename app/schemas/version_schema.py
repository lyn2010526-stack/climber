"""Schema: version - Pydantic schemas for data validation."""
...
class VersionBase(BaseModel):
    ...
    status: VersionStatus = Field(default=VersionStatus.ACTIVE, description='Status')
    priority: VersionPriority = Field(default=VersionPriority.MEDIUM, description='Priority')
    category: VersionCategory = Field(default=VersionCategory.GENERAL, description='Category')
...
class VersionUpdate(BaseModel):
    ...
    priority: VersionPriority | None = None
    category: VersionCategory | None = None
...
class VersionListResponse(BaseModel):
    ...
    items: list[VersionResponse] = Field(default_factory=list)
...
class VersionBulkAction(BaseModel):
    """Bulk action schema."""
