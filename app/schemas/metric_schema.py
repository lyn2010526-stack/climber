"""Schema: metric - Pydantic schemas for data validation."""
...
class MetricBase(BaseModel):
    ...
    status: MetricStatus = Field(default=MetricStatus.ACTIVE, description='Status')
    priority: MetricPriority = Field(default=MetricPriority.MEDIUM, description='Priority')
    category: MetricCategory = Field(default=MetricCategory.GENERAL, description='Category')
...
class MetricUpdate(BaseModel):
    ...
    priority: MetricPriority | None = None
...
class MetricListResponse(BaseModel):
    ...
    items: list[MetricResponse] = Field(default_factory=list)
...
class MetricBulkAction(BaseModel):
    """Bulk action schema."""
