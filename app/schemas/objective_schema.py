"""Schema: objective - Pydantic schemas for data validation."""
...
class ObjectiveBase(BaseModel):
    ...
    status: ObjectiveStatus = Field(default=ObjectiveStatus.ACTIVE, description='Status')
    priority: ObjectivePriority = Field(default=ObjectivePriority.MEDIUM, description='Priority')
    category: ObjectiveCategory = Field(default=ObjectiveCategory.GENERAL, description='Category')
...
class ObjectiveUpdate(BaseModel):
    ...
    category: ObjectiveCategory | None = None
...
class ObjectiveListResponse(BaseModel):
    ...
    items: list[ObjectiveResponse] = Field(default_factory=list)
...
class ObjectiveBulkAction(BaseModel):
    """Bulk action schema."""
