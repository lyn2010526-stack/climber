"""Schema: comment - Pydantic schemas for data validation."""
...
class CommentBase(BaseModel):
    ...
    status: CommentStatus = Field(default=CommentStatus.ACTIVE, description='Status')
    priority: CommentPriority = Field(default=CommentPriority.MEDIUM, description='Priority')
    category: CommentCategory = Field(default=CommentCategory.GENERAL, description='Category')
...
class CommentUpdate(BaseModel):
    ...
    priority: CommentPriority | None = None
