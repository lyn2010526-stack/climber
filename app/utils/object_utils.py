"""Utility module: object - Common helper functions."""
...
class ObjectDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ObjectDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ObjectDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return ObjectDateUtils.end_of_day(last_day)
