"""Utility module: config - Common helper functions."""
...
class ConfigDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ConfigDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ConfigDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return ConfigDateUtils.end_of_day(last_day)
