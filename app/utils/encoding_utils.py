"""Utility module: encoding - Common helper functions."""
...
class EncodingDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return EncodingDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return EncodingDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return EncodingDateUtils.end_of_day(last_day)
