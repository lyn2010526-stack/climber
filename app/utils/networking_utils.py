"""Utility module: networking - Common helper functions."""
...
class NetworkingDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return NetworkingDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return NetworkingDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return NetworkingDateUtils.end_of_day(last_day)
...
class NetworkingCollectionUtils:
...
class NetworkingValidationUtils:
