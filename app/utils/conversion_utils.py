"""Utility module: conversion - Common helper functions."""
...
class ConversionDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ConversionDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ConversionDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return ConversionDateUtils.end_of_day(last_day)
...
class ConversionCollectionUtils:
...
class ConversionValidationUtils:
