"""Utility module: audio - Common helper functions."""
...
class AudioDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return AudioDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return AudioDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return AudioDateUtils.end_of_day(last_day)
