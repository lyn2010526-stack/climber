"""Utility module: security - Common helper functions."""
...
class SecurityDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return SecurityDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return SecurityDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return SecurityDateUtils.end_of_day(last_day)
