"""Utility module: number - Common helper functions."""
...
class NumberDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return NumberDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return NumberDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return NumberDateUtils.end_of_day(last_day)
