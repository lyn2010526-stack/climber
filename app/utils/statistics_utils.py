"""Utility module: statistics - Common helper functions."""
...
class StatisticsDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return StatisticsDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return StatisticsDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return StatisticsDateUtils.end_of_day(last_day)
...
class StatisticsCollectionUtils:
...
class StatisticsValidationUtils:
