"""Utility module: math - Common helper functions."""
...
class MathDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return MathDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return MathDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return MathDateUtils.end_of_day(last_day)
