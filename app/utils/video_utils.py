"""Utility module: video - Common helper functions."""
...
class VideoDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return VideoDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return VideoDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return VideoDateUtils.end_of_day(last_day)
