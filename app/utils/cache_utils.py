"""Utility module: cache - Common helper functions."""
...
class CacheDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return CacheDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return CacheDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return CacheDateUtils.end_of_day(last_day)
