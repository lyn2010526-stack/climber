"""Utility module: array - Common helper functions."""
...
class ArrayDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ArrayDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ArrayDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return ArrayDateUtils.end_of_day(last_day)
