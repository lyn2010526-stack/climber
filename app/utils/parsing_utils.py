"""Utility module: parsing - Common helper functions."""
...
class ParsingDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ParsingDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ParsingDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return ParsingDateUtils.end_of_day(last_day)
