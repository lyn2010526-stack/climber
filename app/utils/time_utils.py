"""Utility module: time - Common helper functions."""
...
class TimeDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return TimeDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return TimeDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return TimeDateUtils.end_of_day(last_day)
