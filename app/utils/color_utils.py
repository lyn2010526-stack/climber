"""Utility module: color - Common helper functions."""
...
class ColorDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ColorDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ColorDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return ColorDateUtils.end_of_day(last_day)
