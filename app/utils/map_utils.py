"""Utility module: map - Common helper functions."""
...
class MapDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return MapDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return MapDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return MapDateUtils.end_of_day(last_day)
