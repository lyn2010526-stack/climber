"""Utility module: serialization - Common helper functions."""
...
class SerializationStringUtils:
...
class SerializationDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return SerializationDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return SerializationDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return SerializationDateUtils.end_of_day(last_day)
...
class SerializationNumericUtils:
    """Numeric utilities."""
...
class SerializationCollectionUtils:
...
class SerializationCryptoUtils:
...
class SerializationValidationUtils:
