"""Utility module: compression - Common helper functions."""
...
class CompressionDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return CompressionDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return CompressionDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return CompressionDateUtils.end_of_day(last_day)
...
class CompressionCollectionUtils:
...
class CompressionValidationUtils:
