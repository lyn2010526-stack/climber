"""Utility module: file - Common helper functions."""
...
class FileDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return FileDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return FileDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return FileDateUtils.end_of_day(last_day)
