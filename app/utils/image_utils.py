"""Utility module: image - Common helper functions."""
...
class ImageDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ImageDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ImageDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return ImageDateUtils.end_of_day(last_day)
