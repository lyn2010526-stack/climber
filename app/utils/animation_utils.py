"""Utility module: animation - Common helper functions."""
...
class AnimationDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return AnimationDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return AnimationDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return AnimationDateUtils.end_of_day(last_day)
...
class AnimationCollectionUtils:
...
class AnimationValidationUtils:
