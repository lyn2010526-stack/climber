"""Utility module: geometry - Common helper functions."""
...
class GeometryDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return GeometryDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return GeometryDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return GeometryDateUtils.end_of_day(last_day)
