"""Utility module: text - Common helper functions."""
...
class TextDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return TextDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return TextDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return TextDateUtils.end_of_day(last_day)
