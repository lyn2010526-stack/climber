"""Utility module: formatting - Common helper functions."""
...
class FormattingDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return FormattingDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return FormattingDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return FormattingDateUtils.end_of_day(last_day)
...
class FormattingCollectionUtils:
...
class FormattingValidationUtils:
