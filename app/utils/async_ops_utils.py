"""Utility module: async_ops - Common helper functions."""
...
class AsyncOpsDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return AsyncOpsDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return AsyncOpsDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return AsyncOpsDateUtils.end_of_day(last_day)
