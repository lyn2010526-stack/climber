"""Utility module: http - Common helper functions."""
...
class HttpDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return HttpDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return HttpDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return HttpDateUtils.end_of_day(last_day)
