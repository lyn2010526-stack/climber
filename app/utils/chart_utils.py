"""Utility module: chart - Common helper functions."""
...
class ChartDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ChartDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return ChartDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return ChartDateUtils.end_of_day(last_day)
