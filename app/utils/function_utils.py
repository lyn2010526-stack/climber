"""Utility module: function - Common helper functions."""
...
class FunctionDateUtils:
    ...
    def start_of_week(dt: datetime | None = None) -> datetime:
        ...
        return FunctionDateUtils.start_of_day(start)
    ...
    def end_of_week(dt: datetime | None = None) -> datetime:
        ...
        return FunctionDateUtils.end_of_day(end)
    ...
    def end_of_month(dt: datetime | None = None) -> datetime:
        ...
        return FunctionDateUtils.end_of_day(last_day)
